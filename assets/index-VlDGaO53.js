...
⠀⠀⠀⠀⠀⠀⢀⡏⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠊⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⢻⣆
⠀⠀⠀⠀⠀⠀⢸⣧⡶⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠠⣴⠞⠋⠉`.split(`
`),l=Y(()=>{if(!a.value)return null;if(a.value.details&&a.value.details.toLowerCase().includes(`idling`))return`idling`;let e=a.value.name,t=e===`Zed`,n=e===`IntelliJ IDEA Ultimate`||e===`IntelliJ IDEA`||e===`Android Studio`,r=``,i=``;return n?(r=a.value.details||``,i=a.value.state||``):t?(r=a.value.state||``,i=a.value.details||``):(r=a.value.details||``,i=a.value.state||``),r=r.replace(/editing /i,``).replace(/working on /i,``).trim(),i=i.replace(/in /i,``).replace(/workspace: /i,``).trim(),{name:e,workspace:i,filename:r}}),u=Y(()=>{if(!l.value||l.value===`idling`)return null;let e=l.value.name;return e===`Zed`?`zed`:e===`IntelliJ IDEA Ultimate`||e===`IntelliJ IDEA`?`intellij`:e===`Android Studio`?`android-studio`:`vscode`});return(e,d)=>(H(),U(`div`,El,[d[10]||=W(`div`,{class:`text-catppuccin-subtle text-sm mb-2`},` ~$ neofetch --live `,-1),W(`div`,Dl,[W(`div`,Ol,[W(`pre`,kl,[(H(!0),U(B,null,z(I(c),(e,t)=>(H(),U(B,{key:t},[K(k(e)+`
`,1)],64))),128))]),d[0]||=W(`span`,{class:`ascii-tooltip`},[K(`Art by `),W(`a`,{href:`https://www.instagram.com/vilthuril.rah/`,target:`_blank`,rel:`noopener noreferrer`,class:`ascii-tooltip-link`},`@vilthuril.rah`),K(` on Instagram`)],-1)]),W(`div`,Al,[d[8]||=ma(`<div class="mb-1" data-v-d4b5a8df><span class="text-catppuccin-mauve font-bold" data-v-d4b5a8df>Bitz</span><span class="text-catppuccin-blue font-bold" data-v-d4b5a8df>OS</span><span class="text-catppuccin-subtle" data-v-d4b5a8df> (v0.1.4)</span></div><div class="text-catppuccin-surface mb-2" data-v-d4b5a8df> ------------------ </div>`,2),s.value.name?(H(),U(`div`,jl,[d[1]||=W(`span`,{class:`text-catppuccin-mauve font-bold w-20 flex-shrink-0`},`browser`,-1),d[2]||=W(`span`,{class:`text-catppuccin-subtle mr-1`},`-`,-1),W(`span`,Ml,k(s.value.name)+` `+k(s.value.version),1)])):q(``,!0),!o.value&&i.value?(H(),U(`div`,Nl,[d[3]||=W(`span`,{class:`text-catppuccin-mauve font-bold w-20 flex-shrink-0`},`discord`,-1),d[4]||=W(`span`,{class:`text-catppuccin-subtle mr-1`},`-`,-1),W(`span`,Pl,k(i.value.username),1),W(`span`,{class:O([t.value,`ml-1`])},`[`+k(r.value)+`]`,3)])):q(``,!0),!o.value&&n.value?(H(),U(`div`,Fl,[d[5]||=W(`span`,{class:`text-catppuccin-mauve font-bold w-20 flex-shrink-0`},`spotify`,-1),d[6]||=W(`span`,{class:`text-catppuccin-subtle mr-1`},`-`,-1),W(`span`,Il,k(n.value.song)+` - `+k(n.value.artist),1)])):q(``,!0),!o.value&&a.value&&l.value&&l.value!==`idling`&&(l.value.workspace||l.value.filename)?(H(),U(`div`,Ll,[W(`span`,Rl,k(u.value),1),d[7]||=W(`span`,{class:`text-catppuccin-subtle mr-1`},`-`,-1),W(`span`,zl,[l.value.workspace?(H(),U(`span`,Bl,k(l.value.workspace.toLowerCase()),1)):q(``,!0),l.value.workspace&&l.value.filename?(H(),U(`span`,Vl,`/`)):q(``,!0),l.value.filename?(H(),U(`span`,Hl,k(l.value.filename.toLowerCase()),1)):q(``,!0)])])):q(``,!0),d[9]||=ma(`<div class="text-catppuccin-surface mb-2" data-v-d4b5a8df> ------------------ </div><div class="flex gap-0.5 mt-3" data-v-d4b5a8df><span class="w-4 h-4 rounded-sm bg-catppuccin-red" data-v-d4b5a8df></span><span class="w-4 h-4 rounded-sm bg-catppuccin-peach" data-v-d4b5a8df></span><span class="w-4 h-4 rounded-sm bg-catppuccin-yellow" data-v-d4b5a8df></span><span class="w-4 h-4 rounded-sm bg-catppuccin-green" data-v-d4b5a8df></span><span class="w-4 h-4 rounded-sm bg-catppuccin-teal" data-v-d4b5a8df></span><span class="w-4 h-4 rounded-sm bg-catppuccin-blue" data-v-d4b5a8df></span><span class="w-4 h-4 rounded-sm bg-catppuccin-mauve" data-v-d4b5a8df></span><span class="w-4 h-4 rounded-sm bg-catppuccin-pink" data-v-d4b5a8df></span></div>`,2)])])]))}},[[`__scopeId`,`data-v-d4b5a8df`]]),Wl={class:`mb-6`},Gl={class:`mb-6`},Kl={class:`flex items-center flex-wrap gap-3 text-sm mt-4`},ql=[`href`],Jl=vl({__name:`HeroSection`,setup(e){let t=Tl();return(e,n)=>{let r=Nr(`router-link`);return H(),U(`div`,Wl,[W(`div`,Gl,[n[3]||=ma(`<div class="text-catppuccin-subtle text-sm mb-2" data-v-bf6b4bb8>~$ whoami</div><h1 class="text-3xl md:text-4xl font-bold text-catppuccin-text mb-2" data-v-bf6b4bb8><span class="text-catppuccin-mauve" data-v-bf6b4bb8>jesse</span><span class="text-catppuccin-subtle" data-v-bf6b4bb8>@</span><span class="text-catppuccin-blue" data-v-bf6b4bb8>heckr.dev</span></h1><div class="text-sm text-catppuccin-gray 6" data-v-bf6b4bb8><span class="text-catppuccin-subtle" data-v-bf6b4bb8>aka </span><span class="text-catppuccin-green" data-v-bf6b4bb8>Hecker_01</span></div>`,3),W(`div`,Kl,[(H(!0),U(B,null,z(I(t),e=>(H(),U(B,{key:e.id},[e.external?(H(),U(`a`,{key:1,href:e.href,target:`_blank`,class:`px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all flex items-center gap-1.5 group`,style:D({"--accent-color":e.accentColor})},[n[1]||=W(`span`,{class:`text-xs text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`font-medium transition-colors`,style:D({color:e.accentColor})},`~/`+k(e.label),5),n[2]||=W(`svg`,{class:`w-3 h-3 text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`},[W(`path`,{"stroke-linecap":`round`,"stroke-linejoin":`round`,"stroke-width":`2`,d:`M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14`})],-1)],12,ql)):(H(),oa(r,{key:0,to:e.href,class:`px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all flex items-center gap-1.5 group`,style:D({"--accent-color":e.accentColor})},{default:wn(()=>[n[0]||=W(`span`,{class:`text-xs text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`font-medium transition-colors`,style:D({color:e.accentColor})},`~/`+k(e.label),5)]),_:2},1032,[`to`,`style`]))],64))),128))])]),n[4]||=W(`div`,{class:`border-l-2 border-catppuccin-surface pl-4 mb-4`},[W(`div`,{class:`text-catppuccin-subtle text-sm mb-2`},` ~$ cat about.txt `),W(`p`,{class:`text-catppuccin-text leading-relaxed mb-4`},[K(` Hi! I'm Jesse, a Dutch Software Development Student at Grafisch Lyceum Rotterdam. `),W(`br`),K(` I code all sorts of tools and applications mainly for my own use, I also code plugins for Minecraft and Discord bots, my main goal is to have fun while doing so! `),W(`br`),K(` My passion is Frontend development, but I also enjoy working on backend and mobile projects. `),W(`br`),K(` I've got experience in a lot of different `),W(`a`,{href:`#languages`,class:`text-catppuccin-mauve underline hover:no-underline`},`programming languages`),K(` and frameworks, and I love learning new ones! `)])],-1),G(Ul)])}}},[[`__scopeId`,`data-v-bf6b4bb8`]]),Yl={class:`border-l-2 border-catppuccin-surface pl-4 mb-4`},Xl={key:0,class:`text-sm text-catppuccin-subtle`},Zl={key:1,class:`text-sm text-catppuccin-text`},Ql={key:0,class:`text-catppuccin-subtle`},$l={key:2,class:`text-sm text-catppuccin-subtle`},eu={__name:`LanguagesList`,props:{languages:{type:Array,default:()=>[]},loading:{type:Boolean,default:!1}},setup(e){return(t,n)=>(H(),U(`div`,Yl,[n[0]||=W(`div`,{class:`text-catppuccin-subtle text-sm mb-2`},`~$ ls ~/tools`,-1),e.loading?(H(),U(`div`,Xl,` loading languages... `)):e.languages.length?(H(),U(`div`,Zl,[(H(!0),U(B,null,z(e.languages,(t,n)=>(H(),U(`span`,{key:t.language},[K(k(t.language)+`(`+k(t.count)+`)`,1),n<e.languages.length-1?(H(),U(`span`,Ql,` | `)):q(``,!0)]))),128))])):(H(),U(`div`,$l,` no languages found `))]))}},tu=`---
title: Kitsudo
slug: kitsudo
...
`,lu={mauve:`#cba6f7`,blue:`#89b4fa`,green:`#a6e3a1`,red:`#f38ba8`,pink:`#f5c2e7`,yellow:`#f9e2af`,teal:`#94e2d5`,sapphire:`#74c7ec`,sky:`#89dceb`,lavender:`#b4befe`,peach:`#fab387`,maroon:`#eba0ac`,flamingo:`#f2cdcd`},uu=Object.assign({"/projects/kitsudo.md":tu,"/projects/mcbe-pack-decryptor.md":nu,"/projects/pingr.md":ru,"/projects/portfolio.md":iu,"/projects/recodr.md":au,"/projects/satissuite.md":ou,"/projects/wordr.md":su,"/projects/yume-ramen.md":cu}),du=e=>{let t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n([\s\S]*)$/);if(!t)return{frontmatter:{},content:e};let[,n,r]=t,i={},a=n.split(`
`),o=null,s=``,c=(e,t)=>{t=t.trim(),t.startsWith(`[`)&&t.endsWith(`]`)?i[e]=t.slice(1,-1).split(`,`).map(e=>e.trim()):t===`true`?i[e]=!0:t===`false`?i[e]=!1:i[e]=t};return a.forEach(e=>{if(/^\s+/.test(e)&&!/^\s*\w+:/.test(e)&&o)s+=` `+e.trim();else{o&&s&&c(o,s);let[t,...n]=e.split(`:`);if(!t||t.trim()===``)return;o=t.trim(),s=n.join(`:`).trim()}}),o&&s&&c(o,s),{frontmatter:i,content:r}},fu=()=>{let e=[],t=1;return Object.entries(uu).forEach(([n,r])=>{let{frontmatter:i,content:a}=du(r),o=n.split(`/`).pop().replace(`.md`,``);e.push({id:t++,slug:o,title:i.title||o,description:i.description||``,coverImage:i.coverImage||null,accentColor:i.accentColor||`mauve`,accentColorHex:lu[i.accentColor]||lu.mauve,tags:i.tags||[],url:i.url||null,github:i.github||null,status:i.status||`active`,unlisted:i.unlisted===!0,content:a.trim()})}),e},pu=null,mu=(e=!1)=>(pu||=fu(),(e?[...pu]:pu.filter(e=>!e.unlisted)).sort((e,t)=>e.title.localeCompare(t.title))),hu=e=>mu(!0).find(t=>t.slug===e),gu=()=>{let e=new Set;return mu().forEach(t=>{t.tags.forEach(t=>e.add(t))}),Array.from(e).sort()};function _u(){return mu().map(e=>({id:e.id,slug:e.slug,name:e.title,description:e.description,link:e.url||e.github||`#`,screenshot:e.coverImage,accentColor:e.accentColorHex}))}var vu={class:`border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full`},yu={key:0,class:`text-sm text-catppuccin-subtle`},bu={class:`lg:flex-1 lg:relative`},xu={key:0,class:`w-full flex-1 overflow-hidden bg-catppuccin-surface/30`},Su=[`src`,`alt`],Cu={class:`px-3 py-3 flex-shrink-0`},wu={class:`flex items-start gap-3`},Tu={class:`flex-1 min-w-0`},Eu={class:`text-xs text-catppuccin-gray leading-relaxed`},Du={key:0,class:`flex justify-center gap-1.5 mt-3 flex-shrink-0`},Ou=[`onClick`],ku=vl({__name:`ShowcaseCarousel`,setup(e){let t=hl(),n=F([]),r=F(0),i=F(!1),a=null,o=Y(()=>n.value.length?n.value[r.value]:null),s=e=>{if(e===`kitsudo`){t.push(`/kitsudo`);return}t.push({path:`/projects`,query:{project:e}})};return Cr(()=>{n.value=_u(),n.value.length>1&&(a=setInterval(()=>{i.value||(r.value=(r.value+1)%n.value.length)},1e4))}),Er(()=>{a&&clearInterval(a)}),(e,a)=>(H(),U(`div`,vu,[a[5]||=W(`div`,{class:`text-catppuccin-subtle text-sm mb-3`},`~$ cat ~/showcase`,-1),n.value.length?(H(),U(`div`,{key:1,class:`relative lg:flex-1 flex flex-col`,onMouseenter:a[2]||=e=>i.value=!0,onMouseleave:a[3]||=e=>i.value=!1},[W(`div`,bu,[G(eo,{name:`showcase`,mode:`out-in`},{default:wn(()=>[o.value?(H(),U(`div`,{key:o.value.id,onClick:a[0]||=e=>s(o.value.slug),class:`group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all overflow-hidden border-catppuccin-surface/60 lg:absolute lg:inset-0 flex flex-col cursor-pointer`,style:D({borderColor:`${o.value.accentColor}40`})},[o.value.screenshot?(H(),U(`div`,xu,[W(`img`,{src:o.value.screenshot,alt:o.value.name,class:`w-full h-full object-cover group-hover:scale-105 transition-transform duration-300`},null,8,Su)])):q(``,!0),W(`div`,Cu,[W(`div`,wu,[W(`span`,{class:`transition-colors`,style:D({color:o.value.accentColor})},`>`,4),W(`div`,Tu,[W(`h3`,{class:`text-sm font-medium text-catppuccin-text transition-colors mb-1`,style:D({color:o.value.accentColor})},k(o.value.name),5),W(`p`,Eu,k(o.value.description),1)])])])],4)):q(``,!0)]),_:1})]),n.value.length>1?(H(),U(`div`,Du,[(H(!0),U(B,null,z(n.value,(e,t)=>(H(),U(`button`,{key:`dot-${e.id}`,onClick:e=>r.value=t,class:O([`w-2 h-2.5 rounded-full transition-all`,t===r.value?`bg-catppuccin-mauve w-4`:`bg-catppuccin-surface/60 hover:bg-catppuccin-surface`]),style:D(t===r.value?{backgroundColor:o.value.accentColor}:{})},null,14,Ou))),128))])):q(``,!0),W(`button`,{onClick:a[1]||=e=>I(t).push(`/projects`),class:`mt-3 w-full py-2 px-3 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 text-sm text-catppuccin-subtle hover:text-catppuccin-mauve transition-all flex items-center justify-center gap-2`},[...a[4]||=[W(`span`,null,`more projects`,-1),W(`span`,null,`→`,-1)]])],32)):(H(),U(`div`,yu,` no items to showcase `))]))}},[[`__scopeId`,`data-v-174afb7a`]]),Au=`hecker-01`,ju=async()=>{try{let e=[],t=1;for(;;){let n=await fetch(`https://api.github.com/users/${Au}/repos?per_page=100&page=${t}`);if(!n.ok)break;let r=await n.json();if(!r.length||(e.push(...r),r.length<100))break;t++}let n={};return e.forEach(e=>{e.language&&(n[e.language]=(n[e.language]||0)+1)}),{repos:e,languages:Object.entries(n).sort((e,t)=>t[1]-e[1]).map(([e,t])=>({language:e,count:t})),totalRepos:e.length}}catch(e){return console.error(`Error fetching GitHub data:`,e),{repos:[],languages:[],totalRepos:0}}},Mu=async()=>{let e=new Date;e.getFullYear();try{let t=await fetch(`https://github-contributions-api.jogruber.de/v4/${Au}?y=last`);if(!t.ok)throw Error(`Failed to fetch contribution data`);let n=await t.json(),r=[];if(n.contributions&&n.contributions.forEach(e=>{r.push({date:e.date,count:e.count})}),r.length>0){let t=new Date(e);t.setDate(t.getDate()-371+1);let n=[];for(let e=0;e<371;e++){let i=new Date(t);i.setDate(i.getDate()+e);let a=i.toISOString().split(`T`)[0],o=r.find(e=>e.date===a);n.push({date:a,count:o?o.count:0})}return n}throw Error(`No contributions data available`)}catch(t){console.error(`Error fetching contribution data:`,t);let n=new Map;for(let t=370;t>=0;t--){let r=new Date(e);r.setDate(r.getDate()-t);let i=r.toISOString().split(`T`)[0];n.set(i,0)}return Array.from(n.entries()).sort((e,t)=>e[0].localeCompare(t[0])).map(([e,t])=>({date:e,count:t}))}},Nu=e=>e===0?0:e<=2?1:e<=5?2:e<=8?3:4,Pu=e=>`https://github.com/${Au}?tab=overview&from=${e}&to=${e}`,Fu={class:`mt-6 border-l-2 border-catppuccin-surface pl-4`},Iu={class:`flex items-center justify-between mb-3`},Lu={key:0,class:`flex items-center gap-1 text-[10px] text-catppuccin-subtle`},Ru={key:0},zu={key:1},Bu={class:`overflow-x-auto md:overflow-visible pb-2 md:pb-0 scrollbar-thin`},Vu={class:`inline-flex md:flex gap-[3px] md:gap-1`,style:{"min-width":`max-content`}},Hu=[`href`,`title`],Uu=[`title`],Wu={class:`text-xs text-catppuccin-gray mt-2`},Gu={__name:`ContributionGraph`,setup(e){let t=F([]),n=F(!0),r=Y(()=>{let e=[];for(let n=0;n<t.value.length;n+=7)e.push(t.value.slice(n,n+7));return e}),i=Y(()=>t.value.reduce((e,t)=>e+t.count,0)),a=async()=>{try{n.value=!0,t.value=await Mu()}catch{}finally{n.value=!1}};return Cr(()=>{a()}),(e,t)=>(H(),U(`div`,Fu,[W(`div`,Iu,[t[1]||=W(`div`,{class:`text-catppuccin-subtle text-sm`},` ~$ git log --oneline --since="1.year.ago" | wc -l `,-1),n.value?q(``,!0):(H(),U(`div`,Lu,[...t[0]||=[ma(`<span>less</span><div class="flex gap-[1px]"><div class="w-2 h-2 rounded-[2px] bg-catppuccin-surface/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/30"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/70"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green"></div></div><span>more</span>`,3)]]))]),n.value?(H(),U(`div`,Ru,[...t[2]||=[W(`div`,{class:`h-[60px] bg-catppuccin-surface/30 rounded cursor-blink`},null,-1)]])):(H(),U(`div`,zu,[W(`div`,Bu,[W(`div`,Vu,[(H(!0),U(B,null,z(r.value,(e,t)=>(H(),U(`div`,{key:t,class:`flex flex-col gap-[3px] md:gap-1 md:flex-1`},[(H(!0),U(B,null,z(e,(e,t)=>(H(),U(B,{key:t},[e.count>0?(H(),U(`a`,{key:0,href:I(Pu)(e.date),target:`_blank`,rel:`noopener noreferrer`,class:O([`w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm transition-all hover:ring-1 hover:ring-catppuccin-green hover:scale-110 cursor-pointer`,[I(Nu)(e.count)===1?`bg-catppuccin-green/30 hover:bg-catppuccin-green/40`:I(Nu)(e.count)===2?`bg-catppuccin-green/50 hover:bg-catppuccin-green/60`:I(Nu)(e.count)===3?`bg-catppuccin-green/70 hover:bg-catppuccin-green/80`:`bg-catppuccin-green hover:bg-catppuccin-green`]]),title:`${e.date}: ${e.count} contributions - Click to view on GitHub`},null,10,Hu)):(H(),U(`div`,{key:1,class:`w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm bg-catppuccin-surface/50`,title:`${e.date}: ${e.count} contributions`},null,8,Uu))],64))),128))]))),128))])]),W(`div`,Wu,k(i.value)+` contributions in the last year `,1)]))]))}},Ku={class:`w-full py-8 text-center text-sm text-catppuccin-subtle dark:text-gray-400`},qu={__name:`Footer`,setup(e){let t=new Date().getFullYear();return(e,n)=>(H(),U(`footer`,Ku,[W(`p`,null,`© 2020 - `+k(I(t))+` heckr.dev | All rights reserved.`,1)]))}},Ju={class:`border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full`},Yu={class:`lg:flex-1 flex flex-col`},Xu={key:0,class:`space-y-2`},Zu={key:1,class:`text-sm text-catppuccin-subtle`},Qu=[`href`],$u={class:`flex items-start gap-3 text-sm hover:text-catppuccin-mauve transition-colors px-3 py-2`},ed={class:`flex-1 min-w-0`},td={class:`flex items-center gap-2`},nd=[`title`],rd={key:0,class:`text-catppuccin-yellow text-xs flex-shrink-0`},id=[`title`],ad={key:3,class:`text-sm text-catppuccin-subtle`},od=vl({__name:`ReposList`,props:{repos:{type:Array,default:()=>[]},loading:{type:Boolean,default:!1}},setup(e){let t=e,n=Y(()=>t.repos.length?[...t.repos].sort((e,t)=>t.stargazers_count-e.stargazers_count).slice(0,6):[]);return(t,r)=>(H(),U(`div`,Ju,[r[2]||=W(`div`,{class:`text-catppuccin-subtle text-sm mb-3`},` ~$ ls ~/repositories `,-1),W(`div`,Yu,[e.loading?(H(),U(`div`,Xu,[(H(),U(B,null,z(6,e=>W(`div`,{key:`repo-loading-${e}`,class:`rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 p-3`},[...r[0]||=[ma(`<div class="flex items-start gap-3" data-v-5dddb934><span class="text-catppuccin-subtle" data-v-5dddb934>&gt;</span><div class="flex-1 min-w-0" data-v-5dddb934><div class="h-3 bg-catppuccin-surface/70 rounded w-2/3 mb-2 cursor-blink" data-v-5dddb934></div><div class="h-2 bg-catppuccin-surface/50 rounded w-1/3 cursor-blink" data-v-5dddb934></div></div></div>`,1)]])),64))])):e.repos.length?n.value.length?(H(),oa(Jo,{key:2,name:`list`,tag:`div`,class:`space-y-2`},{default:wn(()=>[(H(!0),U(B,null,z(n.value,e=>(H(),U(`a`,{key:e.id,href:e.html_url,target:`_blank`,class:`block group rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-colors`},[W(`div`,$u,[r[1]||=W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors`},`>`,-1),W(`div`,ed,[W(`div`,td,[W(`span`,{class:`text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors font-medium truncate`,title:e.name},k(e.name),9,nd),e.stargazers_count>0?(H(),U(`span`,rd,` ★`+k(e.stargazers_count),1)):q(``,!0)]),W(`p`,{class:`text-xs text-catppuccin-gray truncate`,title:e.description},k(e.description||`no description`),9,id)])])],8,Qu))),128))]),_:1})):(H(),U(`div`,ad,` no repositories found `)):(H(),U(`div`,Zu,` no projects found `))])]))}},[[`__scopeId`,`data-v-5dddb934`]]),sd={class:`w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono`},cd={class:`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-10 md:pb-2`},ld={class:`grid lg:grid-cols-2 gap-6 lg:items-stretch`},ud={__name:`Home`,setup(e){let t=F([]),n=F(!0),r=F([]),i=async()=>{try{n.value=!0;let{repos:e,languages:i}=await ju(`hecker-01`);t.value=e,r.value=i}catch{}finally{n.value=!1}};return Cr(()=>{i()}),(e,i)=>(H(),U(`div`,sd,[W(`div`,cd,[G(Jl),G(eu,{languages:r.value,loading:n.value,id:`languages`},null,8,[`languages`,`loading`]),W(`div`,ld,[G(od,{repos:t.value,loading:n.value},null,8,[`repos`,`loading`]),G(ku)]),G(Gu),G(qu)])]))}},dd=Object.assign({"/posts/docker-and-compose.md":`---
...
`)}_restoreDetailsBlocks(e,t){for(let n=t.detailsBlocks.length-1;n>=0;n--){let r=t.detailsBlocks[n],i=this.parse(r.content),a=`<details class="my-4 border border-catppuccin-surface rounded overflow-hidden">
      ...
      </div>`}_renderTable(e){let t=e[0],n=e.slice(2),r=`<div class="overflow-x-auto -mx-2 sm:mx-0 my-4"><table class="w-full text-sm border-collapse min-w-[400px]">`,i=t.split(`|`).filter(e=>e.trim());return r+=`<thead><tr>`,i.forEach(e=>{r+=`<th class="border border-catppuccin-surface px-3 py-2 text-left text-catppuccin-mauve bg-catppuccin-surface/30">${e.trim()}</th>`}),r+=`</tr></thead>`,r+=`<tbody>`,n.forEach(e=>{if(e.trim()&&!/^\|[\s\-:|]+\|$/.test(e)){let t=e.split(`|`).filter(e=>e.trim());r+=`<tr>`,t.forEach(e=>{r+=`<td class="border border-catppuccin-surface px-3 py-2 text-catppuccin-text">${e.trim()}</td>`}),r+=`</tr>`}}),r+=`</tbody></table></div>`,r}_slugify(e){return e.toLowerCase().replace(/<[^>]*>/g,``).replace(/[^\w\s-]/g,``).replace(/\s+/g,`-`).replace(/-+/g,`-`).trim()}},Wd=new class{highlightAll(){window.Prism&&(Prism.highlightAll(),document.querySelectorAll(`pre[class*="language-"]`).forEach(e=>{e.className=e.className.replace(/language-\S+/g,``).trim()}))}highlightAfterDelay(e=100){setTimeout(()=>this.highlightAll(),e)}},Gd=[`src`,`alt`],Kd=1,qd=4,Jd=vl({__name:`ImageLightbox`,props:{src:{type:String,default:null},alt:{type:String,default:``}},emits:[`close`],setup(e,{emit:t}){let n=e,r=t,i=F(1),a=F(0),o=F(0),s=!1,c=0,l=1,u=0,d=0,f=0,p=0,m=0,h=Y(()=>({transform:`translate(${a.value}px, ${o.value}px) scale(${i.value})`,transition:s?`none`:`transform 0.2s ease`})),g=()=>{i.value=1,a.value=0,o.value=0},_=()=>{g(),r(`close`)},v=e=>{let t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.hypot(t,n)},y=e=>{if(e.touches.length===2)s=!0,c=v(e.touches),l=i.value;else if(e.touches.length===1){let t=Date.now();if(t-m<300){i.value>1?g():i.value=2,m=0;return}m=t,f=e.touches[0].clientX,p=e.touches[0].clientY,u=a.value,d=o.value}},b=e=>{if(e.touches.length===2){e.preventDefault();let t=v(e.touches),n=l*t/c;i.value=Math.min(qd,Math.max(Kd,n))}else e.touches.length===1&&i.value>1&&(e.preventDefault(),a.value=u+(e.touches[0].clientX-f),o.value=d+(e.touches[0].clientY-p))},x=e=>{e.touches.length===0&&(s=!1,i.value<=Kd&&g())},S=e=>{e.key===`Escape`&&n.src&&_()};return jn(()=>n.src,g),Cr(()=>window.addEventListener(`keydown`,S)),Dr(()=>window.removeEventListener(`keydown`,S)),(t,n)=>(H(),oa(Gn,{to:`body`},[G(eo,{name:`lightbox-fade`},{default:wn(()=>[e.src?(H(),U(`div`,{key:0,class:`fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[#000000] p-0 sm:bg-[#11111b]/80 sm:backdrop-blur-sm sm:p-4 cursor-zoom-out`,onClick:_},[W(`button`,{type:`button`,class:`absolute top-4 right-4 z-10 w-12 h-12 flex items-center justify-center rounded-full border border-catppuccin-surface/60 bg-catppuccin-base/40 text-2xl leading-none font-light text-catppuccin-subtle hover:text-catppuccin-text hover:border-catppuccin-mauve/40 transition-colors`,"aria-label":`Close image`,onClick:_},` × `),W(`img`,{src:e.src,alt:e.alt,style:D(h.value),class:`max-w-full max-h-screen sm:max-h-[90vh] object-contain rounded-none sm:rounded-md shadow-2xl cursor-default touch-none select-none`,onClick:n[0]||=ss(()=>{},[`stop`]),onTouchstart:y,onTouchmove:b,onTouchend:x},null,44,Gd)])):q(``,!0)]),_:1})]))}},[[`__scopeId`,`data-v-cfdbb40c`]]),Yd={class:`mb-8`},Xd={class:`text-catppuccin-subtle text-sm mb-2`},Zd={class:`text-3xl md:text-4xl font-bold text-catppuccin-mauve mb-3`},Qd={class:`flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-catppuccin-subtle mb-4`},$d={class:`flex flex-wrap gap-2`},ef={key:0,class:`mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10`},tf={class:`space-y-3`},nf=[`for`],rf=[`id`,`onUpdate:modelValue`,`placeholder`],af=[`innerHTML`],of=vl({__name:`PostComponent`,props:{post:{type:Object,required:!0}},emits:[`go-back`],setup(e,{emit:t}){let n=e,r=t,i=()=>{r(`go-back`)},a=Y(()=>n.post.readingTime||1),o=F({}),s=Y(()=>Vd.extractVariables(n.post.content)),c=Y(()=>Vd.substitute(n.post.content,o.value)),l=e=>Ud.parse(e),u=F(null),d=F(``),f=e=>{let t=e.target.closest(`img`);t&&(u.value=t.currentSrc||t.src,d.value=t.alt||``)},p=()=>{u.value=null,d.value=``};return Cr(()=>{Wd.highlightAfterDelay(100)}),jn(o,()=>{pn(()=>{Wd.highlightAll()})},{deep:!0}),(t,n)=>(H(),U(`div`,null,[W(`div`,Yd,[W(`div`,Xd,` ~$ cat `+k(e.post.slug)+`.md `,1),W(`button`,{onClick:i,class:`text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group`},[...n[0]||=[W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`text-catppuccin-mauve font-medium`},`~/posts`,-1)]]),W(`h1`,Zd,k(e.post.title),1),W(`div`,Qd,[W(`span`,null,k(e.post.date),1),n[1]||=W(`span`,{class:`hidden sm:inline text-catppuccin-surface`},`•`,-1),W(`span`,null,`~`+k(a.value)+` min read`,1),n[2]||=W(`span`,{class:`hidden sm:inline text-catppuccin-surface`},`•`,-1),W(`div`,$d,[(H(!0),U(B,null,z(e.post.tags,e=>(H(),U(`span`,{key:e,class:`text-catppuccin-gray`},` #`+k(e),1))),128))])])]),s.value.length>0?(H(),U(`div`,ef,[n[3]||=W(`div`,{class:`text-sm text-catppuccin-subtle mb-3`},` ~$ configure variables `,-1),W(`div`,tf,[(H(!0),U(B,null,z(s.value,e=>(H(),U(`div`,{key:e,class:`flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3`},[W(`label`,{for:`var-${e}`,class:`text-sm text-catppuccin-text sm:min-w-[120px]`},k(e)+`: `,9,nf),Tn(W(`input`,{id:`var-${e}`,"onUpdate:modelValue":t=>o.value[e]=t,type:`text`,placeholder:e,class:`flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors`},null,8,rf),[[is,o.value[e]]])]))),128))])])):q(``,!0),W(`article`,{class:`sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden`,onClick:f},[W(`div`,{class:`prose prose-invert max-w-none text-catppuccin-text`,innerHTML:l(c.value)},null,8,af)]),W(`button`,{onClick:i,class:`text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group`},[...n[4]||=[W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`text-catppuccin-mauve font-medium`},`~/posts`,-1)]]),G(Jd,{src:u.value,alt:d.value,onClose:p},null,8,[`src`,`alt`])]))}},[[`__scopeId`,`data-v-077ea2ea`]]),sf={class:`w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono`},cf={class:`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-14 md:pb-2`},lf={key:`list`},uf={class:`mb-12`},df={class:`flex items-center gap-4 text-sm mb-6`},ff={key:`post`},pf=vl({__name:`Posts`,setup(e){let t=F(`list`),n=F(null),r=F(null),i=F([]),a=F([]),o=gl(),s=hl(),c=Y(()=>r.value?i.value.filter(e=>e.tags.includes(r.value)):i.value),l=()=>{i.value=hd(),a.value=_d()},u=e=>{if(n.value=gd(e),n.value)t.value=`post`,window.scrollTo({top:0,behavior:`instant`}),o.query.post!==e&&s.replace({name:`Posts`,query:{...o.query,post:e}});else if(o.query.post){let e={...o.query};delete e.post,s.replace({name:`Posts`,query:e})}},d=({skipQueryUpdate:e=!1}={})=>{if(t.value=`list`,n.value=null,window.scrollTo({top:0,behavior:`smooth`}),!e&&`post`in o.query){let e={...o.query};delete e.post,s.replace({name:`Posts`,query:e})}},f=e=>{r.value=r.value===e?null:e};return Cr(()=>{l(),document.documentElement.style.overflowY=`auto`,document.body.style.overflowY=`auto`,new ClipboardJS(`[data-clipboard-target]`).on(`success`,function(e){let t=e.trigger,n=t.textContent;t.textContent=`copied!`,t.classList.add(`text-catppuccin-green`),setTimeout(()=>{t.textContent=n,t.classList.remove(`text-catppuccin-green`)},2e3),e.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);let e=o.query.post;e&&u(e)}),Er(()=>{document.documentElement.style.overflowY=``,document.body.style.overflowY=``}),jn(()=>o.query.post,(e,n)=>{e&&e!==n?u(e):!e&&t.value===`post`&&d({skipQueryUpdate:!0})}),(e,i)=>{let o=Nr(`router-link`);return H(),U(`div`,sf,[W(`div`,cf,[G(eo,{name:`fade`,mode:`out-in`},{default:wn(()=>[t.value===`list`?(H(),U(`div`,lf,[W(`div`,uf,[i[1]||=W(`div`,{class:`text-catppuccin-subtle text-sm mb-2`},` ~$ cd ~/posts `,-1),W(`div`,df,[G(o,{to:`/`,class:`px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group`},{default:wn(()=>[...i[0]||=[W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`text-catppuccin-mauve font-medium`},`~/`,-1),W(`span`,{class:`text-catppuccin-subtle font-medium`},`(home)`,-1)]]),_:1})]),i[2]||=W(`h1`,{class:`text-3xl md:text-4xl font-bold text-catppuccin-text mb-4`},[W(`span`,{class:`text-catppuccin-mauve`},`Posts`)],-1),i[3]||=W(`p`,{class:`text-sm text-catppuccin-gray leading-relaxed mb-6`},` My thoughts, tutorials, and experiences on various topics including web development, programming, and technology. `,-1),G(Cd,{tags:a.value,"selected-tag":r.value,onToggleTag:f},null,8,[`tags`,`selected-tag`])]),G(Bd,{posts:c.value,"selected-tag":r.value,onOpenPost:u,onSelectTag:f},null,8,[`posts`,`selected-tag`]),G(qu)])):t.value===`post`&&n.value?(H(),U(`div`,ff,[G(of,{post:n.value,onGoBack:d},null,8,[`post`]),G(qu)])):q(``,!0)]),_:1})])])}}},[[`__scopeId`,`data-v-43b1650d`]]),mf={class:`sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2`},hf={class:`text-catppuccin-subtle text-sm mb-3`},gf={key:0,class:`text-catppuccin-mauve`},_f={key:0,class:`text-sm text-catppuccin-subtle`},vf={key:1,class:`grid gap-4 sm:grid-cols-2`},yf=[`onClick`],bf={key:0,class:`w-full h-32 sm:h-40 overflow-hidden bg-catppuccin-surface/30`},xf=[`src`,`alt`],Sf={class:`px-3 sm:px-4 py-3`},Cf={class:`flex items-start gap-2 mb-2`},wf={class:`text-sm text-catppuccin-gray mb-3 leading-relaxed line-clamp-2`},Tf={class:`flex items-center gap-2 flex-wrap`},Ef=[`onClick`],Df={key:0,class:`text-xs text-catppuccin-subtle`},Of=vl({__name:`ProjectList`,props:{projects:{type:Array,default:()=>[]},selectedTag:{type:String,default:null}},emits:[`open-project`,`select-tag`],setup(e,{emit:t}){let n=t,r=e=>{n(`open-project`,e)};return(t,i)=>(H(),U(`div`,mf,[W(`div`,hf,[i[0]||=K(` ~$ ls -la projects/ `,-1),e.selectedTag?(H(),U(`span`,gf,`| grep "`+k(e.selectedTag)+`"`,1)):q(``,!0)]),e.projects.length?(H(),U(`div`,vf,[(H(!0),U(B,null,z(e.projects,e=>(H(),U(`div`,{key:e.id,onClick:t=>r(e.slug),class:`block group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all cursor-pointer overflow-hidden`,style:D({borderColor:`${e.accentColorHex}40`})},[e.coverImage?(H(),U(`div`,bf,[W(`img`,{src:e.coverImage,alt:e.title,class:`w-full h-full object-cover group-hover:scale-105 transition-transform duration-300`},null,8,xf)])):q(``,!0),W(`div`,Sf,[W(`div`,Cf,[W(`span`,{class:`text-sm transition-colors`,style:D({color:e.accentColorHex})},`>`,4),W(`h2`,{class:`text-base font-semibold text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors`,style:D({"--hover-color":e.accentColorHex})},k(e.title),5)]),W(`p`,wf,k(e.description),1),W(`div`,Tf,[(H(!0),U(B,null,z(e.tags.slice(0,3),t=>(H(),U(`span`,{key:t,onClick:ss(e=>n(`select-tag`,t),[`stop`]),class:`px-2 py-1 sm:py-0.5 rounded text-xs bg-catppuccin-surface/60 text-catppuccin-subtle hover:text-catppuccin-mauve cursor-pointer transition-colors`,style:D({"--hover-bg":`${e.accentColorHex}20`})},` #`+k(t),13,Ef))),128)),e.tags.length>3?(H(),U(`span`,Df,` +`+k(e.tags.length-3),1)):q(``,!0),W(`span`,{class:`ml-auto text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors text-sm`,style:D({"--hover-color":e.accentColorHex})},` view → `,4)])])],12,yf))),128))])):(H(),U(`div`,_f,` no projects found `))]))}},[[`__scopeId`,`data-v-907e807e`]]),kf={class:`mb-8`},Af={class:`text-catppuccin-subtle text-sm mb-2`},jf=[`src`,`alt`],Mf={class:`flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-catppuccin-subtle mb-4`},Nf={class:`flex flex-wrap gap-2`},Pf={class:`flex flex-wrap gap-3 mb-6`},Ff=[`href`],If=[`href`],Lf={key:0,class:`mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10`},Rf={class:`space-y-3`},zf=[`for`],Bf=[`id`,`onUpdate:modelValue`,`placeholder`],Vf=[`innerHTML`],Hf=vl({__name:`ProjectComponent`,props:{project:{type:Object,required:!0},sectioned:{type:Boolean,default:!1}},emits:[`go-back`],setup(e,{emit:t}){let n=e,r=t,i=()=>{r(`go-back`)},a=F({}),o=Y(()=>Vd.extractVariables(n.project.content)),s=Y(()=>Vd.substitute(n.project.content,a.value)),c=e=>{let t=Ud.parse(e);return n.sectioned?t.split(/(?=<h2\b)/i).filter(e=>e.trim()).map(e=>`<section class="project-markdown-section">${e}</section>`).join(``):t};return Cr(()=>{Wd.highlightAfterDelay(100)}),jn(a,()=>{pn(()=>{Wd.highlightAll()})},{deep:!0}),(t,r)=>(H(),U(`div`,{style:D({"--accent-color":e.project.accentColorHex})},[W(`div`,kf,[W(`div`,Af,` ~$ cat `+k(e.project.slug)+`.md `,1),W(`button`,{onClick:i,class:`text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group`},[...r[0]||=[W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`text-catppuccin-mauve font-medium`},`~/projects`,-1)]]),e.project.coverImage?(H(),U(`div`,{key:0,class:`w-full h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden mb-6 border`,style:D({borderColor:`${e.project.accentColorHex}40`})},[W(`img`,{src:e.project.coverImage,alt:e.project.title,class:`w-full h-full object-cover`},null,8,jf)],4)):q(``,!0),W(`h1`,{class:`text-3xl md:text-4xl font-bold mb-3`,style:D({color:e.project.accentColorHex})},k(e.project.title),5),W(`div`,Mf,[W(`span`,{class:O([`px-2 py-0.5 rounded text-xs capitalize`,{"bg-catppuccin-green/20 text-catppuccin-green":e.project.status===`active`,"bg-catppuccin-yellow/20 text-catppuccin-yellow":e.project.status===`in-progress`,"bg-catppuccin-red/20 text-catppuccin-red":e.project.status===`archived`,"bg-catppuccin-blue/20 text-catppuccin-blue":e.project.status===`beta`,"bg-catppuccin-peach/20 text-catppuccin-peach":e.project.status===`stale`}])},k(e.project.status),3),W(`div`,Nf,[(H(!0),U(B,null,z(e.project.tags,e=>(H(),U(`span`,{key:e,class:`text-catppuccin-gray`},` #`+k(e),1))),128))])]),W(`div`,Pf,[e.project.url?(H(),U(`a`,{key:0,href:e.project.url,target:`_blank`,rel:`noopener noreferrer`,class:`inline-flex items-center gap-2 px-3 py-1.5 rounded border text-sm transition-colors hover:bg-catppuccin-surface/30`,style:D({borderColor:`${e.project.accentColorHex}60`,color:e.project.accentColorHex})},[...r[1]||=[W(`svg`,{xmlns:`http://www.w3.org/2000/svg`,class:`w-4 h-4`,fill:`none`,viewBox:`0 0 24 24`,stroke:`currentColor`},[W(`path`,{"stroke-linecap":`round`,"stroke-linejoin":`round`,"stroke-width":`2`,d:`M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14`})],-1),K(` Live Site `,-1)]],12,Ff)):q(``,!0),e.project.github?(H(),U(`a`,{key:1,href:e.project.github,target:`_blank`,rel:`noopener noreferrer`,class:`inline-flex items-center gap-2 px-3 py-1.5 rounded border border-catppuccin-surface/60 text-sm text-catppuccin-subtle transition-colors hover:bg-catppuccin-surface/30 hover:text-catppuccin-text`},[...r[2]||=[W(`svg`,{xmlns:`http://www.w3.org/2000/svg`,class:`w-4 h-4`,fill:`currentColor`,viewBox:`0 0 24 24`},[W(`path`,{d:`M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z`})],-1),K(` GitHub `,-1)]],8,If)):q(``,!0)])]),o.value.length>0?(H(),U(`div`,Lf,[r[3]||=W(`div`,{class:`text-sm text-catppuccin-subtle mb-3`},` ~$ configure variables `,-1),W(`div`,Rf,[(H(!0),U(B,null,z(o.value,e=>(H(),U(`div`,{key:e,class:`flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3`},[W(`label`,{for:`var-${e}`,class:`text-sm text-catppuccin-text sm:min-w-[120px]`},k(e)+`: `,9,zf),Tn(W(`input`,{id:`var-${e}`,"onUpdate:modelValue":t=>a.value[e]=t,type:`text`,placeholder:e,class:`flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors`},null,8,Bf),[[is,a.value[e]]])]))),128))])])):q(``,!0),W(`article`,{class:O([`mb-8 overflow-hidden`,n.sectioned?`sectioned-article`:`sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2`])},[W(`div`,{class:`prose prose-invert max-w-none text-catppuccin-text`,innerHTML:c(s.value)},null,8,Vf)],2),Rr(t.$slots,`default`,{},void 0,!0),W(`button`,{onClick:i,class:`text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group`},[...r[4]||=[W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`text-catppuccin-mauve font-medium`},`~/projects`,-1)]])],4))}},[[`__scopeId`,`data-v-d327634b`]]),Uf={class:`w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono`},Wf={class:`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-14 md:pb-2`},Gf={key:`list`},Kf={class:`mb-12`},qf={class:`flex items-center gap-4 text-sm mb-6`},Jf={key:`project`},Yf=vl({__name:`Projects`,setup(e){let t=F(`list`),n=F(null),r=F(null),i=F([]),a=F([]),o=gl(),s=hl(),c=Y(()=>r.value?i.value.filter(e=>e.tags.includes(r.value)):i.value),l=()=>{i.value=mu(),a.value=gu()},u=e=>{if(e===`kitsudo`){s.push({name:`Kitsudo`});return}if(n.value=hu(e),n.value)t.value=`project`,window.scrollTo({top:0,behavior:`instant`}),o.query.project!==e&&s.replace({name:`Projects`,query:{...o.query,project:e}});else if(o.query.project){let e={...o.query};delete e.project,s.replace({name:`Projects`,query:e})}},d=({skipQueryUpdate:e=!1}={})=>{if(t.value=`list`,n.value=null,window.scrollTo({top:0,behavior:`smooth`}),!e&&`project`in o.query){let e={...o.query};delete e.project,s.replace({name:`Projects`,query:e})}},f=e=>{r.value=r.value===e?null:e};return Cr(()=>{l(),document.documentElement.style.overflowY=`auto`,document.body.style.overflowY=`auto`,new ClipboardJS(`[data-clipboard-target]`).on(`success`,function(e){let t=e.trigger,n=t.textContent;t.textContent=`copied!`,t.classList.add(`text-catppuccin-green`),setTimeout(()=>{t.textContent=n,t.classList.remove(`text-catppuccin-green`)},2e3),e.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);let e=o.query.project;e&&u(e)}),Er(()=>{document.documentElement.style.overflowY=``,document.body.style.overflowY=``}),jn(()=>o.query.project,(e,n)=>{e&&e!==n?u(e):!e&&t.value===`project`&&d({skipQueryUpdate:!0})}),(e,i)=>{let o=Nr(`router-link`);return H(),U(`div`,Uf,[W(`div`,Wf,[G(eo,{name:`fade`,mode:`out-in`},{default:wn(()=>[t.value===`list`?(H(),U(`div`,Gf,[W(`div`,Kf,[i[1]||=W(`div`,{class:`text-catppuccin-subtle text-sm mb-2`},` ~$ cd ~/projects `,-1),W(`div`,qf,[G(o,{to:`/`,class:`px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group`},{default:wn(()=>[...i[0]||=[W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`text-catppuccin-mauve font-medium`},`~/`,-1),W(`span`,{class:`text-catppuccin-subtle font-medium`},`(home)`,-1)]]),_:1})]),i[2]||=W(`h1`,{class:`text-3xl md:text-4xl font-bold text-catppuccin-text mb-4`},[W(`span`,{class:`text-catppuccin-mauve`},`Projects`)],-1),i[3]||=W(`p`,{class:`text-sm text-catppuccin-gray leading-relaxed mb-6`},` A collection of projects I've worked on, ranging from web applications to plugins and tools. `,-1),G(Cd,{tags:a.value,"selected-tag":r.value,onToggleTag:f},null,8,[`tags`,`selected-tag`])]),G(Of,{projects:c.value,"selected-tag":r.value,onOpenProject:u,onSelectTag:f},null,8,[`projects`,`selected-tag`]),G(qu)])):t.value===`project`&&n.value?(H(),U(`div`,Jf,[G(Hf,{project:n.value,sectioned:!0,onGoBack:d},null,8,[`project`]),G(qu)])):q(``,!0)]),_:1})])])}}},[[`__scopeId`,`data-v-d81c3061`]]),Xf={class:`w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono`},Zf={class:`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-6 md:pb-2`},Qf={class:`mb-8`},$f={class:`section-sidebar mb-10`,"aria-labelledby":`screenshots`},ep={class:`grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4`},tp=[`aria-label`,`onClick`],np=[`src`,`alt`],rp={class:`mt-2 text-xs text-catppuccin-subtle`},ip={class:`section-sidebar mb-10`,"aria-labelledby":`wear-os-companion`},ap={class:`grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4`},op=[`aria-label`,`onClick`],sp=[`src`,`alt`],cp={class:`mt-2 text-xs text-catppuccin-subtle`},lp=vl({__name:`Kitsudo`,setup(e){let t=hl(),n=hu(`kitsudo`),r=[{src:`/kitsudo/screenshots/home.jpg`,label:`Today`},{src:`/kitsudo/screenshots/details.jpg`,label:`Task details`},{src:`/kitsudo/screenshots/subtask.jpg`,label:`Subtasks`},{src:`/kitsudo/screenshots/themes.jpg`,label:`Themes`}],i=[{src:`/kitsudo/screenshots/wear-home.png`,label:`Task list`},{src:`/kitsudo/screenshots/wear-details.png`,label:`Task details`},{src:`/kitsudo/screenshots/wear-widget.png`,label:`Watch tile`}],a=()=>t.push(`/projects`),o=F(null),s=F(``),c=(e,t)=>{o.value=e,s.value=t},l=()=>{o.value=null,s.value=``};return(e,t)=>(H(),U(`div`,Xf,[G(Sl),W(`div`,Zf,[G(Hf,{project:I(n),sectioned:!0,onGoBack:a},{default:wn(()=>[W(`div`,Qf,[W(`section`,$f,[t[0]||=W(`h2`,{id:`screenshots`,class:`group text-xl font-semibold text-catppuccin-mauve mb-4`},[K(` Screenshots`),W(`a`,{href:`#screenshots`,class:`ml-2 opacity-0 group-hover:opacity-100 transition-opacity text-catppuccin-subtle hover:text-catppuccin-mauve`,"aria-label":`Link to Screenshots section`},`#`)],-1),t[1]||=W(`p`,{class:`text-catppuccin-text leading-relaxed mb-5`},` The Android app keeps the task list compact while leaving the details, subtasks, and appearance settings close at hand. `,-1),W(`div`,ep,[(H(),U(B,null,z(r,e=>W(`figure`,{key:e.src},[W(`button`,{type:`button`,class:`block w-full rounded-md overflow-hidden border border-catppuccin-surface/60 bg-catppuccin-base/30 p-1.5 cursor-zoom-in`,"aria-label":`Open ${e.label} screenshot`,onClick:t=>c(e.src,`Kitsudo ${e.label} screen`)},[W(`img`,{src:e.src,alt:`Kitsudo ${e.label} screen`,class:`block w-full rounded`,loading:`lazy`},null,8,np)],8,tp),W(`figcaption`,rp,` ./`+k(e.label.toLowerCase().replace(` `,`-`)),1)])),64))])]),W(`section`,ip,[t[2]||=W(`h2`,{id:`wear-os-companion`,class:`group text-xl font-semibold text-catppuccin-mauve mb-4`},[K(` Wear OS companion`),W(`a`,{href:`#wear-os-companion`,class:`ml-2 opacity-0 group-hover:opacity-100 transition-opacity text-catppuccin-subtle hover:text-catppuccin-mauve`,"aria-label":`Link to Wear OS companion section`},`#`)],-1),t[3]||=W(`p`,{class:`text-catppuccin-text leading-relaxed mb-5`},` Check today's tasks, complete them, and open task details from your wrist. Phone and watch sync directly without an account. `,-1),W(`div`,ap,[(H(),U(B,null,z(i,e=>W(`figure`,{key:e.src},[W(`button`,{type:`button`,class:`block w-full rounded-md overflow-hidden border border-catppuccin-surface/60 bg-catppuccin-base/30 p-1.5 cursor-zoom-in`,"aria-label":`Open Wear OS ${e.label} screenshot`,onClick:t=>c(e.src,`Kitsudo Wear OS ${e.label}`)},[W(`img`,{src:e.src,alt:`Kitsudo Wear OS ${e.label}`,class:`block w-full rounded-[28%]`,loading:`lazy`},null,8,sp)],8,op),W(`figcaption`,cp,` ./`+k(e.label.toLowerCase().replace(` `,`-`)),1)])),64))])]),t[4]||=W(`section`,{class:`download-card`,"aria-labelledby":`download-heading`},[W(`div`,{class:`relative w-14 h-14 sm:w-16 sm:h-16 shrink-0 drop-shadow-[0_8px_6px_rgba(0,0,0,0.35)]`,role:`img`,"aria-label":`Kitsudo app icon`},[W(`svg`,{viewBox:`0 0 100 100`,class:`absolute inset-0 w-full h-full`,"aria-hidden":`true`},[W(`defs`,null,[W(`filter`,{id:`kitsudoIconBevel`,x:`-20%`,y:`-20%`,width:`140%`,height:`140%`},[W(`feOffset`,{in:`SourceAlpha`,dx:`0`,dy:`1.5`,result:`downA`}),W(`feGaussianBlur`,{in:`downA`,stdDeviation:`0.8`,result:`downB`}),W(`feComposite`,{in:`SourceAlpha`,in2:`downB`,operator:`out`,result:`topEdge`}),W(`feFlood`,{"flood-color":`#ffffff`,"flood-opacity":`0.2`}),W(`feComposite`,{in2:`topEdge`,operator:`in`,result:`topShine`}),W(`feOffset`,{in:`SourceAlpha`,dx:`0`,dy:`-1.5`,result:`upA`}),W(`feGaussianBlur`,{in:`upA`,stdDeviation:`1.2`,result:`upB`}),W(`feComposite`,{in:`SourceAlpha`,in2:`upB`,operator:`out`,result:`bottomEdge`}),W(`feFlood`,{"flood-color":`#000000`,"flood-opacity":`0.35`}),W(`feComposite`,{in2:`bottomEdge`,operator:`in`,result:`bottomShade`}),W(`feMerge`,null,[W(`feMergeNode`,{in:`SourceGraphic`}),W(`feMergeNode`,{in:`topShine`}),W(`feMergeNode`,{in:`bottomShade`})])])]),W(`path`,{d:`M50,0 C13,0 0,13 0,50 C0,87 13,100 50,100 C87,100 100,87 100,50 C100,13 87,0 50,0 Z`,fill:`#24284b`,filter:`url(#kitsudoIconBevel)`})]),W(`img`,{src:`/kitsudo/logo.svg`,alt:``,class:`absolute inset-[8%] w-auto h-auto object-contain`})]),W(`div`,{class:`flex-1 min-w-[180px]`},[W(`div`,{class:`text-xs text-catppuccin-subtle mb-1`},` ~$ wget kitsudo.apk `),W(`h2`,{id:`download-heading`,class:`text-lg sm:text-xl font-bold text-catppuccin-text mb-1`},` Ready when you are. `),W(`p`,{class:`text-xs sm:text-sm text-catppuccin-gray`},` Free, open-source, and built without ads or tracking. `)]),W(`div`,{class:`flex flex-wrap gap-3`},[W(`a`,{href:`https://play.google.com/store/apps/details?id=dev.heckr.kitsudo`,target:`_blank`,rel:`noopener noreferrer`,class:`download-primary`},` [ Google Play ] `),W(`a`,{href:`https://github.com/hecker-01/Kitsudo/releases/latest`,target:`_blank`,rel:`noopener noreferrer`,class:`download-secondary`},` [ Latest APK ] `)])],-1)])]),_:1},8,[`project`]),G(Jd,{src:o.value,alt:s.value,onClose:l},null,8,[`src`,`alt`]),G(qu)])]))}},[[`__scopeId`,`data-v-53d208e1`]]),up={class:`w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono`},dp={class:`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-16`},fp={class:`mb-8`},pp={class:`text-catppuccin-subtle text-sm mb-4`},mp={class:`border-l-2 border-catppuccin-surface pl-4`},hp={class:`text-catppuccin-red text-sm`},gp={class:`text-catppuccin-mauve`},_p=[{path:`/`,name:`Home`,component:ud,meta:{title:`Home | heckr.dev`}},{path:`/posts`,name:`Posts`,component:pf,meta:{title:`Posts | heckr.dev`}},{path:`/projects`,name:`Projects`,component:Yf,meta:{title:`Projects | heckr.dev`}},{path:`/kitsudo`,name:`Kitsudo`,component:lp,meta:{title:`Kitsudo | heckr.dev`}},{path:`/:pathMatch(.*)*`,name:`NotFound`,component:{__name:`NotFound`,setup(e){let t=gl(),n=hl(),r=Y(()=>(t.fullPath||t.path||`/`).replace(/^\//,``)||`.`),i=()=>n.push(`/`);return(e,t)=>(H(),U(`div`,up,[W(`div`,dp,[W(`div`,fp,[W(`div`,pp,` ~$ cd ~/`+k(r.value),1),W(`div`,{class:`flex items-center gap-4 text-sm mb-6`},[W(`button`,{onClick:i,class:`px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group`},[...t[0]||=[W(`span`,{class:`text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors`},`cd`,-1),W(`span`,{class:`text-catppuccin-mauve font-medium`},`~/`,-1),W(`span`,{class:`text-catppuccin-subtle font-medium`},`(home)`,-1)]])])]),W(`div`,mp,[W(`div`,hp,[t[1]||=K(` cd: no such file or directory: /`,-1),W(`span`,gp,k(r.value),1)]),t[2]||=W(`div`,{class:`mt-3 text-xs text-catppuccin-subtle`},[W(`span`,{class:`text-catppuccin-mauve`,"aria-hidden":`true`},`V*꓃*V`),W(`span`,{class:`ml-2`},`The fox searched its den but couldnt find anything`)],-1)])]),G(qu)]))}},meta:{title:`404 Not Found | heckr.dev`}}],vp=ml({history:Pc(),routes:_p,scrollBehavior(e,t,n){return n||{top:0}}});vp.beforeEach((e,t,n)=>{document.title=e.meta.title||`heckr.dev`,n()});var yp=0,bp=[`ArrowUp`,`ArrowUp`,`ArrowDown`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`ArrowLeft`,`ArrowRight`,`KeyB`,`KeyA`],xp=()=>{console.log(`%cWelcome to heckr.dev`,`font-size: 20px; font-weight: bold; color: #cba6f7;`),console.log(`%cWelcome to the dev console, here are some commands to try:`,`font-size: 14px; color: #a6adc8;`),console.log(`%c- help() - show available commands
...
Feel free to reach out!`,`font-size: 12px; color: #a6adc8;`)},window.secret=()=>{console.log(`%cYou found the secret command`,`font-size: 18px; font-weight: bold; color: #f9e2af;`),console.log(`%cHere's a hint: ↑ ↑ ↓ ↓ ← → ← → B A`,`font-size: 12px; color: #fab387;`)},document.addEventListener(`keydown`,e=>{e.code===bp[yp]?(yp++,yp===bp.length&&(Sp(),yp=0)):yp=0})},Sp=()=>{if(console.log(`%cKONAMI CODE ACTIVATED!`,`font-size: 24px; font-weight: bold; color: #f9e2af; text-shadow: 2px 2px 4px #000;`),document.body.style.animation=`rainbow-border 2s linear infinite`,!document.getElementById(`konami-style`)){let e=document.createElement(`style`);e.id=`konami-style`,e.textContent=`
    ...
    `,document.head.appendChild(e)}setTimeout(()=>{document.body.style.animation=``},5e3)};ds(_l).use(vp).mount(`#app`),document.addEventListener(`dragstart`,e=>{e.target instanceof HTMLImageElement&&e.preventDefault()}),xp();