...
`,Dr={mauve:"#cba6f7",blue:"#89b4fa",green:"#a6e3a1",red:"#f38ba8",pink:"#f5c2e7",yellow:"#f9e2af",teal:"#94e2d5",sapphire:"#74c7ec",sky:"#89dceb",lavender:"#b4befe",peach:"#fab387",maroon:"#eba0ac",flamingo:"#f2cdcd"},Ud=Object.assign({"/projects/portfolio.md":jd,"/projects/satissuite.md":Fd,"/projects/yume-ramen.md":Hd}),Wd=e=>{const t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n([\s\S]*)$/);if(!t)return{frontmatter:{},content:e};const[,n,s]=t,o={},r=n.split(`
`);let i=null,a="";const c=(u,l)=>{l=l.trim(),l.startsWith("[")&&l.endsWith("]")?o[u]=l.slice(1,-1).split(",").map(d=>d.trim()):l==="true"?o[u]=!0:l==="false"?o[u]=!1:o[u]=l};return r.forEach(u=>{if(/^\s+/.test(u)&&!/^\s*\w+:/.test(u)&&i)a+=" "+u.trim();else{i&&a&&c(i,a);const[d,...h]=u.split(":");if(!d||d.trim()==="")return;i=d.trim(),a=h.join(":").trim()}}),i&&a&&c(i,a),{frontmatter:o,content:s}},Vd=()=>{const e=[];let t=1;return Object.entries(Ud).forEach(([n,s])=>{const{frontmatter:o,content:r}=Wd(s),i=n.split("/").pop().replace(".md","");e.push({id:t++,slug:i,title:o.title||i,description:o.description||"",coverImage:o.coverImage||null,accentColor:o.accentColor||"mauve",accentColorHex:Dr[o.accentColor]||Dr.mauve,tags:o.tags||[],url:o.url||null,github:o.github||null,status:o.status||"active",unlisted:o.unlisted===!0,content:r.trim()})}),e};let jn=null;const xs=(e=!1)=>(jn||(jn=Vd()),(e?[...jn]:jn.filter(n=>!n.unlisted)).sort((n,s)=>n.title.localeCompare(s.title))),Gd=e=>xs(!0).find(t=>t.slug===e),qd=()=>{const e=new Set;return xs().forEach(t=>{t.tags.forEach(n=>e.add(n))}),Array.from(e).sort()};function Kd(){return xs().map(e=>({id:e.id,slug:e.slug,name:e.title,description:e.description,link:e.url||e.github||"#",screenshot:e.coverImage,accentColor:e.accentColorHex}))}const zd={class:"border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full"},Yd={key:0,class:"text-sm text-catppuccin-subtle"},Jd={class:"lg:flex-1 lg:relative"},Qd={key:0,class:"w-full flex-1 overflow-hidden bg-catppuccin-surface/30"},Zd=["src","alt"],Xd={class:"px-3 py-3 flex-shrink-0"},ef={class:"flex items-start gap-3"},tf={class:"flex-1 min-w-0"},nf={class:"text-xs text-catppuccin-gray leading-relaxed"},sf={key:0,class:"flex justify-center gap-1.5 mt-3 flex-shrink-0"},of=["onClick"],rf={__name:"ShowcaseCarousel",setup(e){const t=On(),n=ge([]),s=ge(0),o=ge(!1);let r=null;const i=se(()=>n.value.length?n.value[s.value]:null),a=c=>{t.push({path:"/projects",query:{project:c}})};return xt(()=>{n.value=Kd(),n.value.length>1&&(r=setInterval(()=>{o.value||(s.value=(s.value+1)%n.value.length)},1e4))}),In(()=>{r&&clearInterval(r)}),(c,u)=>(C(),S("div",zd,[u[5]||(u[5]=b("div",{class:"text-catppuccin-subtle text-sm mb-3"},"~$ cat ~/showcase",-1)),n.value.length?(C(),S("div",{key:1,class:"relative lg:flex-1 flex flex-col",onMouseenter:u[2]||(u[2]=l=>o.value=!0),onMouseleave:u[3]||(u[3]=l=>o.value=!1)},[b("div",Jd,[K(bs,{name:"showcase",mode:"out-in"},{default:ct(()=>[i.value?(C(),S("div",{key:i.value.id,onClick:u[0]||(u[0]=l=>a(i.value.slug)),class:"group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all overflow-hidden border-catppuccin-surface/60 lg:absolute lg:inset-0 flex flex-col cursor-pointer",style:ye({borderColor:`${i.value.accentColor}40`})},[i.value.screenshot?(C(),S("div",Qd,[b("img",{src:i.value.screenshot,alt:i.value.name,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,Zd)])):he("",!0),b("div",Xd,[b("div",ef,[b("span",{class:"transition-colors",style:ye({color:i.value.accentColor})},">",4),b("div",tf,[b("h3",{class:"text-sm font-medium text-catppuccin-text transition-colors mb-1",style:ye({color:i.value.accentColor})},V(i.value.name),5),b("p",nf,V(i.value.description),1)])])])],4)):he("",!0)]),_:1})]),n.value.length>1?(C(),S("div",sf,[(C(!0),S(oe,null,Pe(n.value,(l,d)=>(C(),S("button",{key:`dot-${l.id}`,onClick:h=>s.value=d,class:$t(["w-2 h-2.5 rounded-full transition-all",d===s.value?"bg-catppuccin-mauve w-4":"bg-catppuccin-surface/60 hover:bg-catppuccin-surface"]),style:ye(d===s.value?{backgroundColor:i.value.accentColor}:{})},null,14,of))),128))])):he("",!0),b("button",{onClick:u[1]||(u[1]=l=>Be(t).push("/projects")),class:"mt-3 w-full py-2 px-3 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 text-sm text-catppuccin-subtle hover:text-catppuccin-mauve transition-all flex items-center justify-center gap-2"},[...u[4]||(u[4]=[b("span",null,"more projects",-1),b("span",null,"→",-1)])])],32)):(C(),S("div",Yd," no items to showcase "))]))}},af=Ot(rf,[["__scopeId","data-v-5e646ea4"]]),So="hecker-01",ha=async()=>{try{const e=[];let t=1;const n=100;for(;;){const r=await fetch(`https://api.github.com/users/${So}/repos?per_page=${n}&page=${t}`);if(!r.ok)break;const i=await r.json();if(!i.length||(e.push(...i),i.length<n))break;t++}const s={};e.forEach(r=>{r.language&&(s[r.language]=(s[r.language]||0)+1)});const o=Object.entries(s).sort((r,i)=>i[1]-r[1]).map(([r,i])=>({language:r,count:i}));return{repos:e,languages:o,totalRepos:e.length}}catch(e){return console.error("Error fetching GitHub data:",e),{repos:[],languages:[],totalRepos:0}}},cf=async()=>{const t=new Date;t.getFullYear();try{const n=await fetch(`https://github-contributions-api.jogruber.de/v4/${So}?y=last`);if(!n.ok)throw new Error("Failed to fetch contribution data");const s=await n.json(),o=[];if(s.contributions&&s.contributions.forEach(r=>{o.push({date:r.date,count:r.count})}),o.length>0){const i=new Date(t);i.setDate(i.getDate()-371+1);const a=[];for(let c=0;c<371;c++){const u=new Date(i);u.setDate(u.getDate()+c);const l=u.toISOString().split("T")[0],d=o.find(h=>h.date===l);a.push({date:l,count:d?d.count:0})}return a}throw new Error("No contributions data available")}catch(n){console.error("Error fetching contribution data:",n);const s=new Map;for(let o=370;o>=0;o--){const r=new Date(t);r.setDate(r.getDate()-o);const i=r.toISOString().split("T")[0];s.set(i,0)}return Array.from(s.entries()).sort((o,r)=>o[0].localeCompare(r[0])).map(([o,r])=>({date:o,count:r}))}},Ns=e=>e===0?0:e<=2?1:e<=5?2:e<=8?3:4,lf=e=>`https://github.com/${So}?tab=overview&from=${e}&to=${e}`,uf={class:"mt-6 border-l-2 border-catppuccin-surface pl-4"},df={class:"flex items-center justify-between mb-3"},ff={key:0,class:"flex items-center gap-1 text-[10px] text-catppuccin-subtle"},pf={key:0},hf={key:1},mf={class:"overflow-x-auto md:overflow-visible pb-2 md:pb-0 scrollbar-thin"},gf={class:"inline-flex md:flex gap-[3px] md:gap-1",style:{"min-width":"max-content"}},bf=["href","title"],vf=["title"],yf={class:"text-xs text-catppuccin-gray mt-2"},xf={__name:"ContributionGraph",setup(e){const t=ge([]),n=ge(!0),s=se(()=>{const i=[];for(let a=0;a<t.value.length;a+=7)i.push(t.value.slice(a,a+7));return i}),o=se(()=>t.value.reduce((i,a)=>i+a.count,0)),r=async()=>{try{n.value=!0,t.value=await cf()}catch{}finally{n.value=!1}};return xt(()=>{r()}),(i,a)=>(C(),S("div",uf,[b("div",df,[a[1]||(a[1]=b("div",{class:"text-catppuccin-subtle text-sm"},' ~$ git log --oneline --since="1.year.ago" | wc -l ',-1)),n.value?he("",!0):(C(),S("div",ff,[...a[0]||(a[0]=[vo('<span>less</span><div class="flex gap-[1px]"><div class="w-2 h-2 rounded-[2px] bg-catppuccin-surface/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/30"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/70"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green"></div></div><span>more</span>',3)])]))]),n.value?(C(),S("div",pf,[...a[2]||(a[2]=[b("div",{class:"h-[60px] bg-catppuccin-surface/30 rounded cursor-blink"},null,-1)])])):(C(),S("div",hf,[b("div",mf,[b("div",gf,[(C(!0),S(oe,null,Pe(s.value,(c,u)=>(C(),S("div",{key:u,class:"flex flex-col gap-[3px] md:gap-1 md:flex-1"},[(C(!0),S(oe,null,Pe(c,(l,d)=>(C(),S(oe,{key:d},[l.count>0?(C(),S("a",{key:0,href:Be(lf)(l.date),target:"_blank",rel:"noopener noreferrer",class:$t(["w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm transition-all hover:ring-1 hover:ring-catppuccin-green hover:scale-110 cursor-pointer",[Be(Ns)(l.count)===1?"bg-catppuccin-green/30 hover:bg-catppuccin-green/40":Be(Ns)(l.count)===2?"bg-catppuccin-green/50 hover:bg-catppuccin-green/60":Be(Ns)(l.count)===3?"bg-catppuccin-green/70 hover:bg-catppuccin-green/80":"bg-catppuccin-green hover:bg-catppuccin-green"]]),title:`${l.date}: ${l.count} contributions - Click to view on GitHub`},null,10,bf)):(C(),S("div",{key:1,class:"w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm bg-catppuccin-surface/50",title:`${l.date}: ${l.count} contributions`},null,8,vf))],64))),128))]))),128))])]),b("div",yf,V(o.value)+" contributions in the last year ",1)]))]))}},wf={class:"w-full py-8 text-center text-sm text-catppuccin-subtle dark:text-gray-400"},an={__name:"Footer",setup(e){const t=new Date().getFullYear();return(n,s)=>(C(),S("footer",wf,[b("p",null,"© 2020 - "+V(Be(t))+" heckr.dev | All rights reserved.",1)]))}},_f={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},kf={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},Cf={class:"grid lg:grid-cols-2 gap-6 lg:items-stretch"},Sf={__name:"Home",setup(e){const t=ge([]),n=ge(!0),s=ge([]),o=async()=>{try{n.value=!0;const{repos:r,languages:i}=await ha("hecker-01");t.value=r,s.value=i}catch{}finally{n.value=!1}};return xt(()=>{o()}),(r,i)=>(C(),S("div",_f,[b("div",kf,[K(vd),K(Cd,{languages:s.value,loading:n.value},null,8,["languages","loading"]),b("div",Cf,[K(Bd,{repos:t.value,loading:n.value},null,8,["repos","loading"]),K(af)]),K(xf),K(an)])]))}},Ef=`---
...
`)}_restoreDetailsBlocks(t,n){for(let s=n.detailsBlocks.length-1;s>=0;s--){const o=n.detailsBlocks[s],r=`<details class="my-4 border border-catppuccin-surface rounded overflow-hidden">
      ...
      </div>`}_renderTable(t){const n=t[0],s=t.slice(2);let o='<div class="overflow-x-auto -mx-2 sm:mx-0 my-4"><table class="w-full text-sm border-collapse min-w-[400px]">';const r=n.split("|").filter(i=>i.trim());return o+="<thead><tr>",r.forEach(i=>{o+=`<th class="border border-catppuccin-surface px-3 py-2 text-left text-catppuccin-mauve bg-catppuccin-surface/30">${i.trim()}</th>`}),o+="</tr></thead>",o+="<tbody>",s.forEach(i=>{if(i.trim()&&!/^\|[\s\-:|]+\|$/.test(i)){const a=i.split("|").filter(c=>c.trim());o+="<tr>",a.forEach(c=>{o+=`<td class="border border-catppuccin-surface px-3 py-2 text-catppuccin-text">${c.trim()}</td>`}),o+="</tr>"}}),o+="</tbody></table></div>",o}_slugify(t){return t.toLowerCase().replace(/<[^>]*>/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}}const ga=new ip;class ap{highlightAll(){window.Prism&&(Prism.highlightAll(),document.querySelectorAll('pre[class*="language-"]').forEach(t=>{t.className=t.className.replace(/language-\S+/g,"").trim()}))}highlightAfterDelay(t=100){setTimeout(()=>this.highlightAll(),t)}}const ns=new ap,cp={class:"mb-8"},lp={class:"text-catppuccin-subtle text-sm mb-2"},up={class:"text-3xl md:text-4xl font-bold text-catppuccin-mauve mb-3"},dp={class:"flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-catppuccin-subtle mb-4"},fp={class:"flex flex-wrap gap-2"},pp={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},hp={class:"space-y-3"},mp=["for"],gp=["id","onUpdate:modelValue","placeholder"],bp={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden"},vp=["innerHTML"],yp={__name:"PostComponent",props:{post:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=se(()=>n.post.readingTime||1),i=ge({}),a=se(()=>ts.extractVariables(n.post.content)),c=se(()=>ts.substitute(n.post.content,i.value)),u=l=>ga.parse(l);return xt(()=>{ns.highlightAfterDelay(100)}),Rt(i,()=>{us(()=>{ns.highlightAll()})},{deep:!0}),(l,d)=>(C(),S("div",null,[b("div",cp,[b("div",lp," ~$ cat "+V(e.post.slug)+".md ",1),b("button",{onClick:o,class:"text-sm text-catppuccin-subtle hover:text-catppuccin-text transition-colors mb-6 inline-flex items-center gap-1"}," [← back to posts] "),b("h1",up,V(e.post.title),1),b("div",dp,[b("span",null,V(e.post.date),1),d[0]||(d[0]=b("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),b("span",null,"~"+V(r.value)+" min read",1),d[1]||(d[1]=b("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),b("div",fp,[(C(!0),S(oe,null,Pe(e.post.tags,h=>(C(),S("span",{key:h,class:"text-catppuccin-gray"}," #"+V(h),1))),128))])])]),a.value.length>0?(C(),S("div",pp,[d[2]||(d[2]=b("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),b("div",hp,[(C(!0),S(oe,null,Pe(a.value,h=>(C(),S("div",{key:h,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[b("label",{for:`var-${h}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},V(h)+": ",9,mp),ui(b("input",{id:`var-${h}`,"onUpdate:modelValue":m=>i.value[h]=m,type:"text",placeholder:h,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,gp),[[ea,i.value[h]]])]))),128))])])):he("",!0),b("article",bp,[b("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:u(c.value)},null,8,vp)]),b("button",{onClick:o,class:"text-sm text-catppuccin-subtle hover:text-catppuccin-mauve transition-colors inline-flex items-center gap-1"}," [← back to all posts] ")]))}},xp=Ot(yp,[["__scopeId","data-v-4c8558f1"]]),wp={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},_p={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},kp={key:"list"},Cp={class:"mb-12"},Sp={class:"flex items-center gap-4 text-sm mb-6"},Ep={key:"post"},Ap={__name:"Posts",setup(e){const t=ge("list"),n=ge(null),s=ge(null),o=ge([]),r=ge([]),i=Co(),a=On(),c=se(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=Eo(),r.value=Mf()},l=m=>{if(n.value=Lf(m),n.value)t.value="post",window.scrollTo({top:0,behavior:"smooth"}),i.query.post!==m&&a.replace({name:"Posts",query:{...i.query,post:m}});else if(i.query.post){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"post"in i.query){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},h=m=>{s.value=s.value===m?null:m};return xt(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(E){const N=E.trigger,O=N.textContent;N.textContent="copied!",N.classList.add("text-catppuccin-green"),setTimeout(()=>{N.textContent=O,N.classList.remove("text-catppuccin-green")},2e3),E.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.post;v&&l(v)}),In(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),Rt(()=>i.query.post,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="post"&&d({skipQueryUpdate:!0})}),(m,v)=>{const E=ps("router-link");return C(),S("div",wp,[b("div",_p,[K(bs,{name:"fade",mode:"out-in"},{default:ct(()=>[t.value==="list"?(C(),S("div",kp,[b("div",Cp,[v[1]||(v[1]=b("div",{class:"text-catppuccin-subtle text-sm mb-2"},"~$ cd ~/posts",-1)),b("div",Sp,[K(E,{to:"/",class:"text-catppuccin-subtle hover:text-catppuccin-text transition-colors"},{default:ct(()=>[...v[0]||(v[0]=[Se(" [← home] ",-1)])]),_:1})]),v[2]||(v[2]=b("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[b("span",{class:"text-catppuccin-mauve"},"Posts")],-1)),v[3]||(v[3]=b("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," My thoughts, tutorials, and experiences on various topics including web development, programming, and technology. ",-1)),K(ma,{tags:r.value,"selected-tag":s.value,onToggleTag:h},null,8,["tags","selected-tag"])]),K(sp,{posts:c.value,"selected-tag":s.value,onOpenPost:l,onSelectTag:h},null,8,["posts","selected-tag"]),K(an)])):t.value==="post"&&n.value?(C(),S("div",Ep,[K(xp,{post:n.value,onGoBack:d},null,8,["post"]),K(an)])):he("",!0)]),_:1})])])}}},Tp=Ot(Ap,[["__scopeId","data-v-7a63f85b"]]),Pp={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2"},Rp={class:"text-catppuccin-subtle text-sm mb-3"},Dp={key:0,class:"text-catppuccin-mauve"},Ip={key:0,class:"text-sm text-catppuccin-subtle"},$p={key:1,class:"grid gap-4 sm:grid-cols-2"},Op=["onClick"],Lp={key:0,class:"w-full h-32 sm:h-40 overflow-hidden bg-catppuccin-surface/30"},Mp=["src","alt"],Np={class:"px-3 sm:px-4 py-3"},Bp={class:"flex items-start gap-2 mb-2"},jp={class:"text-sm text-catppuccin-gray mb-3 leading-relaxed line-clamp-2"},Fp={class:"flex items-center gap-2 flex-wrap"},Hp=["onClick"],Up={key:0,class:"text-xs text-catppuccin-subtle"},Wp={__name:"ProjectList",props:{projects:{type:Array,default:()=>[]},selectedTag:{type:String,default:null}},emits:["open-project","select-tag"],setup(e,{emit:t}){const n=t,s=o=>{n("open-project",o)};return(o,r)=>(C(),S("div",Pp,[b("div",Rp,[r[0]||(r[0]=Se(" ~$ ls -la projects/ ",-1)),e.selectedTag?(C(),S("span",Dp,'| grep "'+V(e.selectedTag)+'"',1)):he("",!0)]),e.projects.length?(C(),S("div",$p,[(C(!0),S(oe,null,Pe(e.projects,i=>(C(),S("div",{key:i.id,onClick:a=>s(i.slug),class:"block group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all cursor-pointer overflow-hidden",style:ye({borderColor:`${i.accentColorHex}40`})},[i.coverImage?(C(),S("div",Lp,[b("img",{src:i.coverImage,alt:i.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,Mp)])):he("",!0),b("div",Np,[b("div",Bp,[b("span",{class:"text-sm transition-colors",style:ye({color:i.accentColorHex})},">",4),b("h2",{class:"text-base font-semibold text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors",style:ye({"--hover-color":i.accentColorHex})},V(i.title),5)]),b("p",jp,V(i.description),1),b("div",Fp,[(C(!0),S(oe,null,Pe(i.tags.slice(0,3),a=>(C(),S("span",{key:a,onClick:ta(c=>n("select-tag",a),["stop"]),class:"px-2 py-1 sm:py-0.5 rounded text-xs bg-catppuccin-surface/60 text-catppuccin-subtle hover:text-catppuccin-mauve cursor-pointer transition-colors",style:ye({"--hover-bg":`${i.accentColorHex}20`})}," #"+V(a),13,Hp))),128)),i.tags.length>3?(C(),S("span",Up," +"+V(i.tags.length-3),1)):he("",!0),b("span",{class:"ml-auto text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors text-sm",style:ye({"--hover-color":i.accentColorHex})}," view → ",4)])])],12,Op))),128))])):(C(),S("div",Ip," no projects found "))]))}},Vp=Ot(Wp,[["__scopeId","data-v-b7be8c48"]]),Gp={class:"mb-8"},qp={class:"text-catppuccin-subtle text-sm mb-2"},Kp=["src","alt"],zp={class:"flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-catppuccin-subtle mb-4"},Yp={class:"flex flex-wrap gap-2"},Jp={class:"flex flex-wrap gap-3 mb-6"},Qp=["href"],Zp=["href"],Xp={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},eh={class:"space-y-3"},th=["for"],nh=["id","onUpdate:modelValue","placeholder"],sh=["innerHTML"],oh={__name:"ProjectComponent",props:{project:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=ge({}),i=se(()=>ts.extractVariables(n.project.content)),a=se(()=>ts.substitute(n.project.content,r.value)),c=u=>ga.parse(u);return xt(()=>{ns.highlightAfterDelay(100)}),Rt(r,()=>{us(()=>{ns.highlightAll()})},{deep:!0}),(u,l)=>(C(),S("div",null,[b("div",Gp,[b("div",qp," ~$ cat "+V(e.project.slug)+".md ",1),b("button",{onClick:o,class:"text-sm text-catppuccin-subtle hover:text-catppuccin-text transition-colors mb-6 inline-flex items-center gap-1"}," [← back to projects] "),e.project.coverImage?(C(),S("div",{key:0,class:"w-full h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden mb-6 border",style:ye({borderColor:`${e.project.accentColorHex}40`})},[b("img",{src:e.project.coverImage,alt:e.project.title,class:"w-full h-full object-cover"},null,8,Kp)],4)):he("",!0),b("h1",{class:"text-3xl md:text-4xl font-bold mb-3",style:ye({color:e.project.accentColorHex})},V(e.project.title),5),b("div",zp,[b("span",{class:$t(["px-2 py-0.5 rounded text-xs capitalize",{"bg-catppuccin-green/20 text-catppuccin-green":e.project.status==="active","bg-catppuccin-yellow/20 text-catppuccin-yellow":e.project.status==="in-progress","bg-catppuccin-red/20 text-catppuccin-red":e.project.status==="archived","bg-catppuccin-blue/20 text-catppuccin-blue":e.project.status==="beta"}])},V(e.project.status),3),b("div",Yp,[(C(!0),S(oe,null,Pe(e.project.tags,d=>(C(),S("span",{key:d,class:"text-catppuccin-gray"}," #"+V(d),1))),128))])]),b("div",Jp,[e.project.url?(C(),S("a",{key:0,href:e.project.url,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border text-sm transition-colors hover:bg-catppuccin-surface/30",style:ye({borderColor:`${e.project.accentColorHex}60`,color:e.project.accentColorHex})},[...l[0]||(l[0]=[b("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[b("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})],-1),Se(" Live Site ",-1)])],12,Qp)):he("",!0),e.project.github?(C(),S("a",{key:1,href:e.project.github,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border border-catppuccin-surface/60 text-sm text-catppuccin-subtle transition-colors hover:bg-catppuccin-surface/30 hover:text-catppuccin-text"},[...l[1]||(l[1]=[b("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24"},[b("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})],-1),Se(" GitHub ",-1)])],8,Zp)):he("",!0)])]),i.value.length>0?(C(),S("div",Xp,[l[2]||(l[2]=b("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),b("div",eh,[(C(!0),S(oe,null,Pe(i.value,d=>(C(),S("div",{key:d,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[b("label",{for:`var-${d}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},V(d)+": ",9,th),ui(b("input",{id:`var-${d}`,"onUpdate:modelValue":h=>r.value[d]=h,type:"text",placeholder:d,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,nh),[[ea,r.value[d]]])]))),128))])])):he("",!0),b("article",{class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden",style:ye({"--accent-color":e.project.accentColorHex})},[b("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:c(a.value)},null,8,sh)],4),b("button",{onClick:o,class:"text-sm text-catppuccin-subtle hover:text-catppuccin-mauve transition-colors inline-flex items-center gap-1"}," [← back to all projects] ")]))}},rh=Ot(oh,[["__scopeId","data-v-921c6ed4"]]),ih={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},ah={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},ch={key:"list"},lh={class:"mb-12"},uh={class:"flex items-center gap-4 text-sm mb-6"},dh={key:"project"},fh={__name:"Projects",setup(e){const t=ge("list"),n=ge(null),s=ge(null),o=ge([]),r=ge([]),i=Co(),a=On(),c=se(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=xs(),r.value=qd()},l=m=>{if(n.value=Gd(m),n.value)t.value="project",window.scrollTo({top:0,behavior:"smooth"}),i.query.project!==m&&a.replace({name:"Projects",query:{...i.query,project:m}});else if(i.query.project){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"project"in i.query){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},h=m=>{s.value=s.value===m?null:m};return xt(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(E){const N=E.trigger,O=N.textContent;N.textContent="copied!",N.classList.add("text-catppuccin-green"),setTimeout(()=>{N.textContent=O,N.classList.remove("text-catppuccin-green")},2e3),E.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.project;v&&l(v)}),In(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),Rt(()=>i.query.project,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="project"&&d({skipQueryUpdate:!0})}),(m,v)=>{const E=ps("router-link");return C(),S("div",ih,[b("div",ah,[K(bs,{name:"fade",mode:"out-in"},{default:ct(()=>[t.value==="list"?(C(),S("div",ch,[b("div",lh,[v[1]||(v[1]=b("div",{class:"text-catppuccin-subtle text-sm mb-2"}," ~$ cd ~/projects ",-1)),b("div",uh,[K(E,{to:"/",class:"text-catppuccin-subtle hover:text-catppuccin-text transition-colors"},{default:ct(()=>[...v[0]||(v[0]=[Se(" [← home] ",-1)])]),_:1})]),v[2]||(v[2]=b("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[b("span",{class:"text-catppuccin-mauve"},"Projects")],-1)),v[3]||(v[3]=b("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," A collection of projects I've worked on, ranging from web applications to plugins and tools. ",-1)),K(ma,{tags:r.value,"selected-tag":s.value,onToggleTag:h},null,8,["tags","selected-tag"])]),K(Vp,{projects:c.value,"selected-tag":s.value,onOpenProject:l,onSelectTag:h},null,8,["projects","selected-tag"]),K(an)])):t.value==="project"&&n.value?(C(),S("div",dh,[K(rh,{project:n.value,onGoBack:d},null,8,["project"]),K(an)])):he("",!0)]),_:1})])])}}},ph=Ot(fh,[["__scopeId","data-v-87eb9fe5"]]),hh={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},mh={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-16"},gh={class:"mb-8"},bh={class:"text-catppuccin-subtle text-sm mb-4"},vh={class:"border-l-2 border-catppuccin-surface pl-4"},yh={class:"text-catppuccin-red text-sm"},xh={class:"text-catppuccin-mauve"},wh={__name:"NotFound",setup(e){const t=Co(),n=On(),s=se(()=>(t.fullPath||t.path||"/").replace(/^\//,"")||"."),o=()=>n.push("/");return(r,i)=>(C(),S("div",hh,[b("div",mh,[b("div",gh,[b("div",bh," ~$ cd ~/"+V(s.value),1),b("div",{class:"flex items-center gap-4 text-sm mb-6"},[b("button",{onClick:o,class:"text-catppuccin-subtle hover:text-catppuccin-text transition-colors"}," [← home] ")])]),b("div",vh,[b("div",yh,[i[0]||(i[0]=Se(" cd: no such file or directory: /",-1)),b("span",xh,V(s.value),1)])])]),K(an)]))}},_h=[{path:"/",name:"Home",component:Sf,meta:{title:"Home | heckr.dev"}},{path:"/posts",name:"Posts",component:Tp,meta:{title:"Posts | heckr.dev"}},{path:"/projects",name:"Projects",component:ph,meta:{title:"Projects | heckr.dev"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:wh,meta:{title:"404 Not Found | heckr.dev"}}],ba=Yu({history:Au(),routes:_h,scrollBehavior(e,t,n){return n||{top:0}}});ba.beforeEach((e,t,n)=>{document.title=e.meta.title||"heckr.dev",n()});let fn=0;const Ir=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","KeyB","KeyA"],kh=()=>{console.log("%cWelcome to heckr.dev","font-size: 20px; font-weight: bold; color: #cba6f7;"),console.log("%cWelcome to the dev console, here are some commands to try:","font-size: 14px; color: #a6adc8;"),console.log(`%c- help() - show available commands
...
Feel free to reach out!`,"font-size: 12px; color: #a6adc8;")},window.secret=()=>{console.log("%cYou found the secret command","font-size: 18px; font-weight: bold; color: #f9e2af;"),console.log("%cHere's a hint: ↑ ↑ ↓ ↓ ← → ← → B A","font-size: 12px; color: #fab387;")},document.addEventListener("keydown",e=>{e.code===Ir[fn]?(fn++,fn===Ir.length&&(Ch(),fn=0)):fn=0})},Ch=()=>{if(console.log("%cKONAMI CODE ACTIVATED!","font-size: 24px; font-weight: bold; color: #f9e2af; text-shadow: 2px 2px 4px #000;"),document.body.style.animation="rainbow-border 2s linear infinite",!document.getElementById("konami-style")){const e=document.createElement("style");e.id="konami-style",e.textContent=`
    ...
    `,document.head.appendChild(e)}setTimeout(()=>{document.body.style.animation=""},5e3)};Hl(Ju).use(ba).mount("#app");kh();
