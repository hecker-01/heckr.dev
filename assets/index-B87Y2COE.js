...
⠀⠀⠀⠀⠀⠀⢸⣧⡶⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠠⣴⠞⠋⠉
`.trim().split(`
`),u=ee(()=>{if(!r.value)return null;if(r.value.details&&r.value.details.toLowerCase().includes("idling"))return"idling";const d=r.value.name,f=d==="Zed",E=d==="IntelliJ IDEA Ultimate"||d==="IntelliJ IDEA"||d==="Android Studio";let L="",D="";return E?(L=r.value.details||"",D=r.value.state||""):f?(L=r.value.state||"",D=r.value.details||""):(L=r.value.details||"",D=r.value.state||""),L=L.replace(/editing /i,"").replace(/working on /i,"").trim(),D=D.replace(/in /i,"").replace(/workspace: /i,"").trim(),{name:d,workspace:D,filename:L}}),l=ee(()=>{if(!u.value||u.value==="idling")return null;const d=u.value.name;return d==="Zed"?"zed":d==="IntelliJ IDEA Ultimate"||d==="IntelliJ IDEA"?"intellij":d==="Android Studio"?"android-studio":"vscode"});return(d,f)=>(C(),S("div",td,[f[10]||(f[10]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"},"~$ neofetch --live",-1)),g("div",nd,[g("div",sd,[g("pre",od,[(C(!0),S(Z,null,Ce($e(c),(m,v)=>(C(),S(Z,{key:v},[Ue(V(m)+`
`,1)],64))),128))]),f[0]||(f[0]=g("span",{class:"ascii-tooltip"},[Ue("Art by "),g("a",{href:"https://www.instagram.com/vilthuril.rah/",target:"_blank",rel:"noopener noreferrer",class:"ascii-tooltip-link"},"@vilthuril.rah"),Ue(" on Instagram")],-1))]),g("div",rd,[f[8]||(f[8]=Tn('<div class="mb-1" data-v-d7f88577><span class="text-catppuccin-mauve font-bold" data-v-d7f88577>heck</span><span class="text-catppuccin-blue font-bold" data-v-d7f88577>OS</span><span class="text-catppuccin-subtle" data-v-d7f88577> (v0.1.0)</span></div><div class="text-catppuccin-surface mb-2" data-v-d7f88577>------------------</div>',2)),a.value.name?(C(),S("div",id,[f[1]||(f[1]=g("span",{class:"text-catppuccin-mauve font-bold w-20 flex-shrink-0"},"browser",-1)),f[2]||(f[2]=g("span",{class:"text-catppuccin-subtle mr-1"},"-",-1)),g("span",ad,V(a.value.name)+" "+V(a.value.version),1)])):he("",!0),!i.value&&o.value?(C(),S("div",cd,[f[3]||(f[3]=g("span",{class:"text-catppuccin-mauve font-bold w-20 flex-shrink-0"},"discord",-1)),f[4]||(f[4]=g("span",{class:"text-catppuccin-subtle mr-1"},"-",-1)),g("span",ld,V(o.value.username),1),g("span",{class:Ot([t.value,"ml-1"])},"["+V(s.value)+"]",3)])):he("",!0),!i.value&&n.value?(C(),S("div",ud,[f[5]||(f[5]=g("span",{class:"text-catppuccin-mauve font-bold w-20 flex-shrink-0"},"spotify",-1)),f[6]||(f[6]=g("span",{class:"text-catppuccin-subtle mr-1"},"-",-1)),g("span",dd,V(n.value.song)+" - "+V(n.value.artist),1)])):he("",!0),!i.value&&r.value&&u.value&&u.value!=="idling"&&(u.value.workspace||u.value.filename)?(C(),S("div",pd,[g("span",fd,V(l.value),1),f[7]||(f[7]=g("span",{class:"text-catppuccin-subtle mr-1"},"-",-1)),g("span",hd,[u.value.workspace?(C(),S("span",md,V(u.value.workspace.toLowerCase()),1)):he("",!0),u.value.workspace&&u.value.filename?(C(),S("span",gd,"/")):he("",!0),u.value.filename?(C(),S("span",bd,V(u.value.filename.toLowerCase()),1)):he("",!0)])])):he("",!0),f[9]||(f[9]=Tn('<div class="text-catppuccin-surface mb-2" data-v-d7f88577>------------------</div><div class="flex gap-0.5 mt-3" data-v-d7f88577><span class="w-4 h-4 rounded-sm bg-catppuccin-red" data-v-d7f88577></span><span class="w-4 h-4 rounded-sm bg-catppuccin-peach" data-v-d7f88577></span><span class="w-4 h-4 rounded-sm bg-catppuccin-yellow" data-v-d7f88577></span><span class="w-4 h-4 rounded-sm bg-catppuccin-green" data-v-d7f88577></span><span class="w-4 h-4 rounded-sm bg-catppuccin-teal" data-v-d7f88577></span><span class="w-4 h-4 rounded-sm bg-catppuccin-blue" data-v-d7f88577></span><span class="w-4 h-4 rounded-sm bg-catppuccin-mauve" data-v-d7f88577></span><span class="w-4 h-4 rounded-sm bg-catppuccin-pink" data-v-d7f88577></span></div>',2))])])]))}},yd=wt(vd,[["__scopeId","data-v-d7f88577"]]),xd={class:"mb-6"},wd={class:"mb-6"},_d={class:"flex items-center flex-wrap gap-3 text-sm mt-4"},kd=["href"],Cd={__name:"HeroSection",setup(e){const t=Zu();return(n,s)=>{const o=hs("router-link");return C(),S("div",xd,[g("div",wd,[s[3]||(s[3]=Tn('<div class="text-catppuccin-subtle text-sm mb-2" data-v-0bbc42c2>~$ whoami</div><h1 class="text-3xl md:text-4xl font-bold text-catppuccin-text mb-2" data-v-0bbc42c2><span class="text-catppuccin-mauve" data-v-0bbc42c2>jesse</span><span class="text-catppuccin-subtle" data-v-0bbc42c2>@</span><span class="text-catppuccin-blue" data-v-0bbc42c2>heckr.dev</span></h1><div class="text-sm text-catppuccin-gray 6" data-v-0bbc42c2><span class="text-catppuccin-subtle" data-v-0bbc42c2>aka </span><span class="text-catppuccin-green" data-v-0bbc42c2>Hecker_01</span></div>',3)),g("div",_d,[(C(!0),S(Z,null,Ce($e(t),r=>(C(),S(Z,{key:r.id},[r.external?(C(),S("a",{key:1,href:r.href,target:"_blank",class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all flex items-center gap-1.5 group",style:ye({"--accent-color":r.accentColor})},[s[1]||(s[1]=g("span",{class:"text-xs text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1)),g("span",{class:"font-medium transition-colors",style:ye({color:r.accentColor})},"~/"+V(r.label),5),s[2]||(s[2]=g("svg",{class:"w-3 h-3 text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[g("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})],-1))],12,kd)):(C(),En(o,{key:0,to:r.href,class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all flex items-center gap-1.5 group",style:ye({"--accent-color":r.accentColor})},{default:ct(()=>[s[0]||(s[0]=g("span",{class:"text-xs text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1)),g("span",{class:"font-medium transition-colors",style:ye({color:r.accentColor})},"~/"+V(r.label),5)]),_:2},1032,["to","style"]))],64))),128))])]),s[4]||(s[4]=g("div",{class:"border-l-2 border-catppuccin-surface pl-4 mb-4"},[g("div",{class:"text-catppuccin-subtle text-sm mb-2"},"~$ cat about.txt"),g("p",{class:"text-catppuccin-text leading-relaxed mb-4"},[Ue(" Hi! I'm Jesse, I code things for Minecraft, Discord, random CLI tools, websites, apps and more. "),g("br"),Ue(" My passion is backend development, but I also enjoy working on frontend and mobile projects. "),g("br"),Ue(" I have experience in a lot of different programming languages and frameworks, and I love learning new ones! ")])],-1)),K(yd)])}}},Sd=wt(Cd,[["__scopeId","data-v-0bbc42c2"]]),Ad={class:"border-l-2 border-catppuccin-surface pl-4 mb-4"},Ed={key:0,class:"text-sm text-catppuccin-subtle"},Td={key:1,class:"text-sm text-catppuccin-text"},Pd={key:0,class:"text-catppuccin-subtle"},Rd={key:2,class:"text-sm text-catppuccin-subtle"},Dd={__name:"LanguagesList",props:{languages:{type:Array,default:()=>[]},loading:{type:Boolean,default:!1}},setup(e){return(t,n)=>(C(),S("div",Ad,[n[0]||(n[0]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"},"~$ ls ~/tools",-1)),e.loading?(C(),S("div",Ed," loading languages... ")):e.languages.length?(C(),S("div",Td,[(C(!0),S(Z,null,Ce(e.languages,(s,o)=>(C(),S("span",{key:s.language},[Ue(V(s.language)+"("+V(s.count)+")",1),o<e.languages.length-1?(C(),S("span",Pd," | ")):he("",!0)]))),128))])):(C(),S("div",Rd,"no languages found"))]))}},Id=`---
title: Portfolio
slug: portfolio
...
`,Dr={mauve:"#cba6f7",blue:"#89b4fa",green:"#a6e3a1",red:"#f38ba8",pink:"#f5c2e7",yellow:"#f9e2af",teal:"#94e2d5",sapphire:"#74c7ec",sky:"#89dceb",lavender:"#b4befe",peach:"#fab387",maroon:"#eba0ac",flamingo:"#f2cdcd"},Nd=Object.assign({"/projects/portfolio.md":Id,"/projects/recodr.md":$d,"/projects/satissuite.md":Od,"/projects/wordr.md":Md,"/projects/yume-ramen.md":Ld}),Bd=e=>{const t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n([\s\S]*)$/);if(!t)return{frontmatter:{},content:e};const[,n,s]=t,o={},r=n.split(`
`);let i=null,a="";const c=(u,l)=>{l=l.trim(),l.startsWith("[")&&l.endsWith("]")?o[u]=l.slice(1,-1).split(",").map(d=>d.trim()):l==="true"?o[u]=!0:l==="false"?o[u]=!1:o[u]=l};return r.forEach(u=>{if(/^\s+/.test(u)&&!/^\s*\w+:/.test(u)&&i)a+=" "+u.trim();else{i&&a&&c(i,a);const[d,...f]=u.split(":");if(!d||d.trim()==="")return;i=d.trim(),a=f.join(":").trim()}}),i&&a&&c(i,a),{frontmatter:o,content:s}},jd=()=>{const e=[];let t=1;return Object.entries(Nd).forEach(([n,s])=>{const{frontmatter:o,content:r}=Bd(s),i=n.split("/").pop().replace(".md","");e.push({id:t++,slug:i,title:o.title||i,description:o.description||"",coverImage:o.coverImage||null,accentColor:o.accentColor||"mauve",accentColorHex:Dr[o.accentColor]||Dr.mauve,tags:o.tags||[],url:o.url||null,github:o.github||null,status:o.status||"active",unlisted:o.unlisted===!0,content:r.trim()})}),e};let Fn=null;const ws=(e=!1)=>(Fn||(Fn=jd()),(e?[...Fn]:Fn.filter(n=>!n.unlisted)).sort((n,s)=>n.title.localeCompare(s.title))),Fd=e=>ws(!0).find(t=>t.slug===e),Hd=()=>{const e=new Set;return ws().forEach(t=>{t.tags.forEach(n=>e.add(n))}),Array.from(e).sort()};function Vd(){return ws().map(e=>({id:e.id,slug:e.slug,name:e.title,description:e.description,link:e.url||e.github||"#",screenshot:e.coverImage,accentColor:e.accentColorHex}))}const Ud={class:"border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full"},Wd={key:0,class:"text-sm text-catppuccin-subtle"},Gd={class:"lg:flex-1 lg:relative"},qd={key:0,class:"w-full flex-1 overflow-hidden bg-catppuccin-surface/30"},Kd=["src","alt"],zd={class:"px-3 py-3 flex-shrink-0"},Yd={class:"flex items-start gap-3"},Jd={class:"flex-1 min-w-0"},Qd={class:"text-xs text-catppuccin-gray leading-relaxed"},Zd={key:0,class:"flex justify-center gap-1.5 mt-3 flex-shrink-0"},Xd=["onClick"],ep={__name:"ShowcaseCarousel",setup(e){const t=Mn(),n=me([]),s=me(0),o=me(!1);let r=null;const i=ee(()=>n.value.length?n.value[s.value]:null),a=c=>{t.push({path:"/projects",query:{project:c}})};return lt(()=>{n.value=Vd(),n.value.length>1&&(r=setInterval(()=>{o.value||(s.value=(s.value+1)%n.value.length)},1e4))}),$n(()=>{r&&clearInterval(r)}),(c,u)=>(C(),S("div",Ud,[u[5]||(u[5]=g("div",{class:"text-catppuccin-subtle text-sm mb-3"},"~$ cat ~/showcase",-1)),n.value.length?(C(),S("div",{key:1,class:"relative lg:flex-1 flex flex-col",onMouseenter:u[2]||(u[2]=l=>o.value=!0),onMouseleave:u[3]||(u[3]=l=>o.value=!1)},[g("div",Gd,[K(vs,{name:"showcase",mode:"out-in"},{default:ct(()=>[i.value?(C(),S("div",{key:i.value.id,onClick:u[0]||(u[0]=l=>a(i.value.slug)),class:"group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all overflow-hidden border-catppuccin-surface/60 lg:absolute lg:inset-0 flex flex-col cursor-pointer",style:ye({borderColor:`${i.value.accentColor}40`})},[i.value.screenshot?(C(),S("div",qd,[g("img",{src:i.value.screenshot,alt:i.value.name,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,Kd)])):he("",!0),g("div",zd,[g("div",Yd,[g("span",{class:"transition-colors",style:ye({color:i.value.accentColor})},">",4),g("div",Jd,[g("h3",{class:"text-sm font-medium text-catppuccin-text transition-colors mb-1",style:ye({color:i.value.accentColor})},V(i.value.name),5),g("p",Qd,V(i.value.description),1)])])])],4)):he("",!0)]),_:1})]),n.value.length>1?(C(),S("div",Zd,[(C(!0),S(Z,null,Ce(n.value,(l,d)=>(C(),S("button",{key:`dot-${l.id}`,onClick:f=>s.value=d,class:Ot(["w-2 h-2.5 rounded-full transition-all",d===s.value?"bg-catppuccin-mauve w-4":"bg-catppuccin-surface/60 hover:bg-catppuccin-surface"]),style:ye(d===s.value?{backgroundColor:i.value.accentColor}:{})},null,14,Xd))),128))])):he("",!0),g("button",{onClick:u[1]||(u[1]=l=>$e(t).push("/projects")),class:"mt-3 w-full py-2 px-3 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 text-sm text-catppuccin-subtle hover:text-catppuccin-mauve transition-all flex items-center justify-center gap-2"},[...u[4]||(u[4]=[g("span",null,"more projects",-1),g("span",null,"→",-1)])])],32)):(C(),S("div",Wd," no items to showcase "))]))}},tp=wt(ep,[["__scopeId","data-v-5e646ea4"]]),So="hecker-01",ha=async()=>{try{const e=[];let t=1;const n=100;for(;;){const r=await fetch(`https://api.github.com/users/${So}/repos?per_page=${n}&page=${t}`);if(!r.ok)break;const i=await r.json();if(!i.length||(e.push(...i),i.length<n))break;t++}const s={};e.forEach(r=>{r.language&&(s[r.language]=(s[r.language]||0)+1)});const o=Object.entries(s).sort((r,i)=>i[1]-r[1]).map(([r,i])=>({language:r,count:i}));return{repos:e,languages:o,totalRepos:e.length}}catch(e){return console.error("Error fetching GitHub data:",e),{repos:[],languages:[],totalRepos:0}}},np=async()=>{const t=new Date;t.getFullYear();try{const n=await fetch(`https://github-contributions-api.jogruber.de/v4/${So}?y=last`);if(!n.ok)throw new Error("Failed to fetch contribution data");const s=await n.json(),o=[];if(s.contributions&&s.contributions.forEach(r=>{o.push({date:r.date,count:r.count})}),o.length>0){const i=new Date(t);i.setDate(i.getDate()-371+1);const a=[];for(let c=0;c<371;c++){const u=new Date(i);u.setDate(u.getDate()+c);const l=u.toISOString().split("T")[0],d=o.find(f=>f.date===l);a.push({date:l,count:d?d.count:0})}return a}throw new Error("No contributions data available")}catch(n){console.error("Error fetching contribution data:",n);const s=new Map;for(let o=370;o>=0;o--){const r=new Date(t);r.setDate(r.getDate()-o);const i=r.toISOString().split("T")[0];s.set(i,0)}return Array.from(s.entries()).sort((o,r)=>o[0].localeCompare(r[0])).map(([o,r])=>({date:o,count:r}))}},Bs=e=>e===0?0:e<=2?1:e<=5?2:e<=8?3:4,sp=e=>`https://github.com/${So}?tab=overview&from=${e}&to=${e}`,op={class:"mt-6 border-l-2 border-catppuccin-surface pl-4"},rp={class:"flex items-center justify-between mb-3"},ip={key:0,class:"flex items-center gap-1 text-[10px] text-catppuccin-subtle"},ap={key:0},cp={key:1},lp={class:"overflow-x-auto md:overflow-visible pb-2 md:pb-0 scrollbar-thin"},up={class:"inline-flex md:flex gap-[3px] md:gap-1",style:{"min-width":"max-content"}},dp=["href","title"],pp=["title"],fp={class:"text-xs text-catppuccin-gray mt-2"},hp={__name:"ContributionGraph",setup(e){const t=me([]),n=me(!0),s=ee(()=>{const i=[];for(let a=0;a<t.value.length;a+=7)i.push(t.value.slice(a,a+7));return i}),o=ee(()=>t.value.reduce((i,a)=>i+a.count,0)),r=async()=>{try{n.value=!0,t.value=await np()}catch{}finally{n.value=!1}};return lt(()=>{r()}),(i,a)=>(C(),S("div",op,[g("div",rp,[a[1]||(a[1]=g("div",{class:"text-catppuccin-subtle text-sm"},' ~$ git log --oneline --since="1.year.ago" | wc -l ',-1)),n.value?he("",!0):(C(),S("div",ip,[...a[0]||(a[0]=[Tn('<span>less</span><div class="flex gap-[1px]"><div class="w-2 h-2 rounded-[2px] bg-catppuccin-surface/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/30"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/70"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green"></div></div><span>more</span>',3)])]))]),n.value?(C(),S("div",ap,[...a[2]||(a[2]=[g("div",{class:"h-[60px] bg-catppuccin-surface/30 rounded cursor-blink"},null,-1)])])):(C(),S("div",cp,[g("div",lp,[g("div",up,[(C(!0),S(Z,null,Ce(s.value,(c,u)=>(C(),S("div",{key:u,class:"flex flex-col gap-[3px] md:gap-1 md:flex-1"},[(C(!0),S(Z,null,Ce(c,(l,d)=>(C(),S(Z,{key:d},[l.count>0?(C(),S("a",{key:0,href:$e(sp)(l.date),target:"_blank",rel:"noopener noreferrer",class:Ot(["w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm transition-all hover:ring-1 hover:ring-catppuccin-green hover:scale-110 cursor-pointer",[$e(Bs)(l.count)===1?"bg-catppuccin-green/30 hover:bg-catppuccin-green/40":$e(Bs)(l.count)===2?"bg-catppuccin-green/50 hover:bg-catppuccin-green/60":$e(Bs)(l.count)===3?"bg-catppuccin-green/70 hover:bg-catppuccin-green/80":"bg-catppuccin-green hover:bg-catppuccin-green"]]),title:`${l.date}: ${l.count} contributions - Click to view on GitHub`},null,10,dp)):(C(),S("div",{key:1,class:"w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm bg-catppuccin-surface/50",title:`${l.date}: ${l.count} contributions`},null,8,pp))],64))),128))]))),128))])]),g("div",fp,V(o.value)+" contributions in the last year ",1)]))]))}},mp={class:"w-full py-8 text-center text-sm text-catppuccin-subtle dark:text-gray-400"},an={__name:"Footer",setup(e){const t=new Date().getFullYear();return(n,s)=>(C(),S("footer",mp,[g("p",null,"© 2020 - "+V($e(t))+" heckr.dev | All rights reserved.",1)]))}},gp={class:"border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full"},bp={class:"lg:flex-1 flex flex-col"},vp={key:0,class:"space-y-2"},yp={key:1,class:"text-sm text-catppuccin-subtle"},xp=["href"],wp={class:"flex items-start gap-3 text-sm hover:text-catppuccin-mauve transition-colors px-3 py-2"},_p={class:"flex-1 min-w-0"},kp={class:"flex items-center gap-2"},Cp=["title"],Sp={key:0,class:"text-catppuccin-yellow text-xs flex-shrink-0"},Ap=["title"],Ep={key:3,class:"text-sm text-catppuccin-subtle"},Tp={__name:"ReposList",props:{repos:{type:Array,default:()=>[]},loading:{type:Boolean,default:!1}},setup(e){const t=e,n=ee(()=>t.repos.length?[...t.repos].sort((s,o)=>o.stargazers_count-s.stargazers_count).slice(0,6):[]);return(s,o)=>(C(),S("div",gp,[o[2]||(o[2]=g("div",{class:"text-catppuccin-subtle text-sm mb-3"},"~$ ls ~/repositories",-1)),g("div",bp,[e.loading?(C(),S("div",vp,[(C(),S(Z,null,Ce(6,r=>g("div",{key:`repo-loading-${r}`,class:"rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 p-3"},[...o[0]||(o[0]=[Tn('<div class="flex items-start gap-3" data-v-effaf9c1><span class="text-catppuccin-subtle" data-v-effaf9c1>&gt;</span><div class="flex-1 min-w-0" data-v-effaf9c1><div class="h-3 bg-catppuccin-surface/70 rounded w-2/3 mb-2 cursor-blink" data-v-effaf9c1></div><div class="h-2 bg-catppuccin-surface/50 rounded w-1/3 cursor-blink" data-v-effaf9c1></div></div></div>',1)])])),64))])):e.repos.length?n.value.length?(C(),En(Dl,{key:2,name:"list",tag:"div",class:"space-y-2"},{default:ct(()=>[(C(!0),S(Z,null,Ce(n.value,r=>(C(),S("a",{key:r.id,href:r.html_url,target:"_blank",class:"block group rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-colors"},[g("div",wp,[o[1]||(o[1]=g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors"},">",-1)),g("div",_p,[g("div",kp,[g("span",{class:"text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors font-medium truncate",title:r.name},V(r.name),9,Cp),r.stargazers_count>0?(C(),S("span",Sp," ★"+V(r.stargazers_count),1)):he("",!0)]),g("p",{class:"text-xs text-catppuccin-gray truncate",title:r.description},V(r.description||"no description"),9,Ap)])])],8,xp))),128))]),_:1})):(C(),S("div",Ep," no repositories found ")):(C(),S("div",yp," no projects found "))])]))}},Pp=wt(Tp,[["__scopeId","data-v-effaf9c1"]]),Rp={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Dp={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},Ip={class:"grid lg:grid-cols-2 gap-6 lg:items-stretch"},$p={__name:"Home",setup(e){const t=me([]),n=me(!0),s=me([]),o=async()=>{try{n.value=!0;const{repos:r,languages:i}=await ha("hecker-01");t.value=r,s.value=i}catch{}finally{n.value=!1}};return lt(()=>{o()}),(r,i)=>(C(),S("div",Rp,[g("div",Dp,[K(Sd),K(Dd,{languages:s.value,loading:n.value},null,8,["languages","loading"]),g("div",Ip,[K(Pp,{repos:t.value,loading:n.value},null,8,["repos","loading"]),K(tp)]),K(hp),K(an)])]))}},Op=`---
...
`)}_restoreDetailsBlocks(t,n){for(let s=n.detailsBlocks.length-1;s>=0;s--){const o=n.detailsBlocks[s],r=`<details class="my-4 border border-catppuccin-surface rounded overflow-hidden">
      ...
      </div>`}_renderTable(t){const n=t[0],s=t.slice(2);let o='<div class="overflow-x-auto -mx-2 sm:mx-0 my-4"><table class="w-full text-sm border-collapse min-w-[400px]">';const r=n.split("|").filter(i=>i.trim());return o+="<thead><tr>",r.forEach(i=>{o+=`<th class="border border-catppuccin-surface px-3 py-2 text-left text-catppuccin-mauve bg-catppuccin-surface/30">${i.trim()}</th>`}),o+="</tr></thead>",o+="<tbody>",s.forEach(i=>{if(i.trim()&&!/^\|[\s\-:|]+\|$/.test(i)){const a=i.split("|").filter(c=>c.trim());o+="<tr>",a.forEach(c=>{o+=`<td class="border border-catppuccin-surface px-3 py-2 text-catppuccin-text">${c.trim()}</td>`}),o+="</tr>"}}),o+="</tbody></table></div>",o}_slugify(t){return t.toLowerCase().replace(/<[^>]*>/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}}const ga=new mf;class gf{highlightAll(){window.Prism&&(Prism.highlightAll(),document.querySelectorAll('pre[class*="language-"]').forEach(t=>{t.className=t.className.replace(/language-\S+/g,"").trim()}))}highlightAfterDelay(t=100){setTimeout(()=>this.highlightAll(),t)}}const ss=new gf,bf={class:"mb-8"},vf={class:"text-catppuccin-subtle text-sm mb-2"},yf={class:"text-3xl md:text-4xl font-bold text-catppuccin-mauve mb-3"},xf={class:"flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-catppuccin-subtle mb-4"},wf={class:"flex flex-wrap gap-2"},_f={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},kf={class:"space-y-3"},Cf=["for"],Sf=["id","onUpdate:modelValue","placeholder"],Af={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden"},Ef=["innerHTML"],Tf={__name:"PostComponent",props:{post:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=ee(()=>n.post.readingTime||1),i=me({}),a=ee(()=>ns.extractVariables(n.post.content)),c=ee(()=>ns.substitute(n.post.content,i.value)),u=l=>ga.parse(l);return lt(()=>{ss.highlightAfterDelay(100)}),Dt(i,()=>{ds(()=>{ss.highlightAll()})},{deep:!0}),(l,d)=>(C(),S("div",null,[g("div",bf,[g("div",vf," ~$ cat "+V(e.post.slug)+".md ",1),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group"},[...d[0]||(d[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/posts",-1)])]),g("h1",yf,V(e.post.title),1),g("div",xf,[g("span",null,V(e.post.date),1),d[1]||(d[1]=g("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),g("span",null,"~"+V(r.value)+" min read",1),d[2]||(d[2]=g("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),g("div",wf,[(C(!0),S(Z,null,Ce(e.post.tags,f=>(C(),S("span",{key:f,class:"text-catppuccin-gray"}," #"+V(f),1))),128))])])]),a.value.length>0?(C(),S("div",_f,[d[3]||(d[3]=g("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),g("div",kf,[(C(!0),S(Z,null,Ce(a.value,f=>(C(),S("div",{key:f,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[g("label",{for:`var-${f}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},V(f)+": ",9,Cf),ui(g("input",{id:`var-${f}`,"onUpdate:modelValue":m=>i.value[f]=m,type:"text",placeholder:f,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,Sf),[[ea,i.value[f]]])]))),128))])])):he("",!0),g("article",Af,[g("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:u(c.value)},null,8,Ef)]),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...d[4]||(d[4]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/posts",-1)])])]))}},Pf=wt(Tf,[["__scopeId","data-v-c0ce7b1a"]]),Rf={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Df={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},If={key:"list"},$f={class:"mb-12"},Of={class:"flex items-center gap-4 text-sm mb-6"},Mf={key:"post"},Lf={__name:"Posts",setup(e){const t=me("list"),n=me(null),s=me(null),o=me([]),r=me([]),i=Co(),a=Mn(),c=ee(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=Ao(),r.value=Wp()},l=m=>{if(n.value=Up(m),n.value)t.value="post",window.scrollTo({top:0,behavior:"instant"}),i.query.post!==m&&a.replace({name:"Posts",query:{...i.query,post:m}});else if(i.query.post){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"post"in i.query){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},f=m=>{s.value=s.value===m?null:m};return lt(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(E){const L=E.trigger,D=L.textContent;L.textContent="copied!",L.classList.add("text-catppuccin-green"),setTimeout(()=>{L.textContent=D,L.classList.remove("text-catppuccin-green")},2e3),E.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.post;v&&l(v)}),$n(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),Dt(()=>i.query.post,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="post"&&d({skipQueryUpdate:!0})}),(m,v)=>{const E=hs("router-link");return C(),S("div",Rf,[g("div",Df,[K(vs,{name:"fade",mode:"out-in"},{default:ct(()=>[t.value==="list"?(C(),S("div",If,[g("div",$f,[v[1]||(v[1]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"},"~$ cd ~/posts",-1)),g("div",Of,[K(E,{to:"/",class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},{default:ct(()=>[...v[0]||(v[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])]),_:1})]),v[2]||(v[2]=g("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[g("span",{class:"text-catppuccin-mauve"},"Posts")],-1)),v[3]||(v[3]=g("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," My thoughts, tutorials, and experiences on various topics including web development, programming, and technology. ",-1)),K(ma,{tags:r.value,"selected-tag":s.value,onToggleTag:f},null,8,["tags","selected-tag"])]),K(pf,{posts:c.value,"selected-tag":s.value,onOpenPost:l,onSelectTag:f},null,8,["posts","selected-tag"]),K(an)])):t.value==="post"&&n.value?(C(),S("div",Mf,[K(Pf,{post:n.value,onGoBack:d},null,8,["post"]),K(an)])):he("",!0)]),_:1})])])}}},Nf=wt(Lf,[["__scopeId","data-v-4f36b454"]]),Bf={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2"},jf={class:"text-catppuccin-subtle text-sm mb-3"},Ff={key:0,class:"text-catppuccin-mauve"},Hf={key:0,class:"text-sm text-catppuccin-subtle"},Vf={key:1,class:"grid gap-4 sm:grid-cols-2"},Uf=["onClick"],Wf={key:0,class:"w-full h-32 sm:h-40 overflow-hidden bg-catppuccin-surface/30"},Gf=["src","alt"],qf={class:"px-3 sm:px-4 py-3"},Kf={class:"flex items-start gap-2 mb-2"},zf={class:"text-sm text-catppuccin-gray mb-3 leading-relaxed line-clamp-2"},Yf={class:"flex items-center gap-2 flex-wrap"},Jf=["onClick"],Qf={key:0,class:"text-xs text-catppuccin-subtle"},Zf={__name:"ProjectList",props:{projects:{type:Array,default:()=>[]},selectedTag:{type:String,default:null}},emits:["open-project","select-tag"],setup(e,{emit:t}){const n=t,s=o=>{n("open-project",o)};return(o,r)=>(C(),S("div",Bf,[g("div",jf,[r[0]||(r[0]=Ue(" ~$ ls -la projects/ ",-1)),e.selectedTag?(C(),S("span",Ff,'| grep "'+V(e.selectedTag)+'"',1)):he("",!0)]),e.projects.length?(C(),S("div",Vf,[(C(!0),S(Z,null,Ce(e.projects,i=>(C(),S("div",{key:i.id,onClick:a=>s(i.slug),class:"block group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all cursor-pointer overflow-hidden",style:ye({borderColor:`${i.accentColorHex}40`})},[i.coverImage?(C(),S("div",Wf,[g("img",{src:i.coverImage,alt:i.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,Gf)])):he("",!0),g("div",qf,[g("div",Kf,[g("span",{class:"text-sm transition-colors",style:ye({color:i.accentColorHex})},">",4),g("h2",{class:"text-base font-semibold text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors",style:ye({"--hover-color":i.accentColorHex})},V(i.title),5)]),g("p",zf,V(i.description),1),g("div",Yf,[(C(!0),S(Z,null,Ce(i.tags.slice(0,3),a=>(C(),S("span",{key:a,onClick:ta(c=>n("select-tag",a),["stop"]),class:"px-2 py-1 sm:py-0.5 rounded text-xs bg-catppuccin-surface/60 text-catppuccin-subtle hover:text-catppuccin-mauve cursor-pointer transition-colors",style:ye({"--hover-bg":`${i.accentColorHex}20`})}," #"+V(a),13,Jf))),128)),i.tags.length>3?(C(),S("span",Qf," +"+V(i.tags.length-3),1)):he("",!0),g("span",{class:"ml-auto text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors text-sm",style:ye({"--hover-color":i.accentColorHex})}," view → ",4)])])],12,Uf))),128))])):(C(),S("div",Hf," no projects found "))]))}},Xf=wt(Zf,[["__scopeId","data-v-b7be8c48"]]),eh={class:"mb-8"},th={class:"text-catppuccin-subtle text-sm mb-2"},nh=["src","alt"],sh={class:"flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-catppuccin-subtle mb-4"},oh={class:"flex flex-wrap gap-2"},rh={class:"flex flex-wrap gap-3 mb-6"},ih=["href"],ah=["href"],ch={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},lh={class:"space-y-3"},uh=["for"],dh=["id","onUpdate:modelValue","placeholder"],ph={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden"},fh=["innerHTML"],hh={__name:"ProjectComponent",props:{project:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=me({}),i=ee(()=>ns.extractVariables(n.project.content)),a=ee(()=>ns.substitute(n.project.content,r.value)),c=u=>ga.parse(u);return lt(()=>{ss.highlightAfterDelay(100)}),Dt(r,()=>{ds(()=>{ss.highlightAll()})},{deep:!0}),(u,l)=>(C(),S("div",{style:ye({"--accent-color":e.project.accentColorHex})},[g("div",eh,[g("div",th," ~$ cat "+V(e.project.slug)+".md ",1),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group"},[...l[0]||(l[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/projects",-1)])]),e.project.coverImage?(C(),S("div",{key:0,class:"w-full h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden mb-6 border",style:ye({borderColor:`${e.project.accentColorHex}40`})},[g("img",{src:e.project.coverImage,alt:e.project.title,class:"w-full h-full object-cover"},null,8,nh)],4)):he("",!0),g("h1",{class:"text-3xl md:text-4xl font-bold mb-3",style:ye({color:e.project.accentColorHex})},V(e.project.title),5),g("div",sh,[g("span",{class:Ot(["px-2 py-0.5 rounded text-xs capitalize",{"bg-catppuccin-green/20 text-catppuccin-green":e.project.status==="active","bg-catppuccin-yellow/20 text-catppuccin-yellow":e.project.status==="in-progress","bg-catppuccin-red/20 text-catppuccin-red":e.project.status==="archived","bg-catppuccin-blue/20 text-catppuccin-blue":e.project.status==="beta"}])},V(e.project.status),3),g("div",oh,[(C(!0),S(Z,null,Ce(e.project.tags,d=>(C(),S("span",{key:d,class:"text-catppuccin-gray"}," #"+V(d),1))),128))])]),g("div",rh,[e.project.url?(C(),S("a",{key:0,href:e.project.url,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border text-sm transition-colors hover:bg-catppuccin-surface/30",style:ye({borderColor:`${e.project.accentColorHex}60`,color:e.project.accentColorHex})},[...l[1]||(l[1]=[g("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[g("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})],-1),Ue(" Live Site ",-1)])],12,ih)):he("",!0),e.project.github?(C(),S("a",{key:1,href:e.project.github,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border border-catppuccin-surface/60 text-sm text-catppuccin-subtle transition-colors hover:bg-catppuccin-surface/30 hover:text-catppuccin-text"},[...l[2]||(l[2]=[g("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24"},[g("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})],-1),Ue(" GitHub ",-1)])],8,ah)):he("",!0)])]),i.value.length>0?(C(),S("div",ch,[l[3]||(l[3]=g("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),g("div",lh,[(C(!0),S(Z,null,Ce(i.value,d=>(C(),S("div",{key:d,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[g("label",{for:`var-${d}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},V(d)+": ",9,uh),ui(g("input",{id:`var-${d}`,"onUpdate:modelValue":f=>r.value[d]=f,type:"text",placeholder:d,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,dh),[[ea,r.value[d]]])]))),128))])])):he("",!0),g("article",ph,[g("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:c(a.value)},null,8,fh)]),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...l[4]||(l[4]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/projects",-1)])])],4))}},mh=wt(hh,[["__scopeId","data-v-da23f289"]]),gh={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},bh={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},vh={key:"list"},yh={class:"mb-12"},xh={class:"flex items-center gap-4 text-sm mb-6"},wh={key:"project"},_h={__name:"Projects",setup(e){const t=me("list"),n=me(null),s=me(null),o=me([]),r=me([]),i=Co(),a=Mn(),c=ee(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=ws(),r.value=Hd()},l=m=>{if(n.value=Fd(m),n.value)t.value="project",window.scrollTo({top:0,behavior:"instant"}),i.query.project!==m&&a.replace({name:"Projects",query:{...i.query,project:m}});else if(i.query.project){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"project"in i.query){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},f=m=>{s.value=s.value===m?null:m};return lt(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(E){const L=E.trigger,D=L.textContent;L.textContent="copied!",L.classList.add("text-catppuccin-green"),setTimeout(()=>{L.textContent=D,L.classList.remove("text-catppuccin-green")},2e3),E.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.project;v&&l(v)}),$n(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),Dt(()=>i.query.project,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="project"&&d({skipQueryUpdate:!0})}),(m,v)=>{const E=hs("router-link");return C(),S("div",gh,[g("div",bh,[K(vs,{name:"fade",mode:"out-in"},{default:ct(()=>[t.value==="list"?(C(),S("div",vh,[g("div",yh,[v[1]||(v[1]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"}," ~$ cd ~/projects ",-1)),g("div",xh,[K(E,{to:"/",class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},{default:ct(()=>[...v[0]||(v[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])]),_:1})]),v[2]||(v[2]=g("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[g("span",{class:"text-catppuccin-mauve"},"Projects")],-1)),v[3]||(v[3]=g("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," A collection of projects I've worked on, ranging from web applications to plugins and tools. ",-1)),K(ma,{tags:r.value,"selected-tag":s.value,onToggleTag:f},null,8,["tags","selected-tag"])]),K(Xf,{projects:c.value,"selected-tag":s.value,onOpenProject:l,onSelectTag:f},null,8,["projects","selected-tag"]),K(an)])):t.value==="project"&&n.value?(C(),S("div",wh,[K(mh,{project:n.value,onGoBack:d},null,8,["project"]),K(an)])):he("",!0)]),_:1})])])}}},kh=wt(_h,[["__scopeId","data-v-ce80c82b"]]),Ch={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Sh={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-16"},Ah={class:"mb-8"},Eh={class:"text-catppuccin-subtle text-sm mb-4"},Th={class:"border-l-2 border-catppuccin-surface pl-4"},Ph={class:"text-catppuccin-red text-sm"},Rh={class:"text-catppuccin-mauve"},Dh={__name:"NotFound",setup(e){const t=Co(),n=Mn(),s=ee(()=>(t.fullPath||t.path||"/").replace(/^\//,"")||"."),o=()=>n.push("/");return(r,i)=>(C(),S("div",Ch,[g("div",Sh,[g("div",Ah,[g("div",Eh," ~$ cd ~/"+V(s.value),1),g("div",{class:"flex items-center gap-4 text-sm mb-6"},[g("button",{onClick:o,class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...i[0]||(i[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])])])]),g("div",Th,[g("div",Ph,[i[1]||(i[1]=Ue(" cd: no such file or directory: /",-1)),g("span",Rh,V(s.value),1)])])]),K(an)]))}},Ih=[{path:"/",name:"Home",component:$p,meta:{title:"Home | heckr.dev"}},{path:"/posts",name:"Posts",component:Nf,meta:{title:"Posts | heckr.dev"}},{path:"/projects",name:"Projects",component:kh,meta:{title:"Projects | heckr.dev"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:Dh,meta:{title:"404 Not Found | heckr.dev"}}],ba=Yu({history:Eu(),routes:Ih,scrollBehavior(e,t,n){return n||{top:0}}});ba.beforeEach((e,t,n)=>{document.title=e.meta.title||"heckr.dev",n()});let pn=0;const Ir=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","KeyB","KeyA"],$h=()=>{console.log("%cWelcome to heckr.dev","font-size: 20px; font-weight: bold; color: #cba6f7;"),console.log("%cWelcome to the dev console, here are some commands to try:","font-size: 14px; color: #a6adc8;"),console.log(`%c- help() - show available commands
...
Feel free to reach out!`,"font-size: 12px; color: #a6adc8;")},window.secret=()=>{console.log("%cYou found the secret command","font-size: 18px; font-weight: bold; color: #f9e2af;"),console.log("%cHere's a hint: ↑ ↑ ↓ ↓ ← → ← → B A","font-size: 12px; color: #fab387;")},document.addEventListener("keydown",e=>{e.code===Ir[pn]?(pn++,pn===Ir.length&&(Oh(),pn=0)):pn=0})},Oh=()=>{if(console.log("%cKONAMI CODE ACTIVATED!","font-size: 24px; font-weight: bold; color: #f9e2af; text-shadow: 2px 2px 4px #000;"),document.body.style.animation="rainbow-border 2s linear infinite",!document.getElementById("konami-style")){const e=document.createElement("style");e.id="konami-style",e.textContent=`
    ...
    `,document.head.appendChild(e)}setTimeout(()=>{document.body.style.animation=""},5e3)};Hl(Ju).use(ba).mount("#app");$h();
