...
`,Hr={mauve:"#cba6f7",blue:"#89b4fa",green:"#a6e3a1",red:"#f38ba8",pink:"#f5c2e7",yellow:"#f9e2af",teal:"#94e2d5",sapphire:"#74c7ec",sky:"#89dceb",lavender:"#b4befe",peach:"#fab387",maroon:"#eba0ac",flamingo:"#f2cdcd"},Qd=Object.assign({"/projects/mcbe-pack-decryptor.md":Wd,"/projects/pingr.md":Gd,"/projects/portfolio.md":qd,"/projects/recodr.md":Kd,"/projects/satissuite.md":Yd,"/projects/wordr.md":zd,"/projects/yume-ramen.md":Jd}),Zd=e=>{const t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n([\s\S]*)$/);if(!t)return{frontmatter:{},content:e};const[,n,s]=t,o={},r=n.split(`
`);let i=null,a="";const c=(u,l)=>{l=l.trim(),l.startsWith("[")&&l.endsWith("]")?o[u]=l.slice(1,-1).split(",").map(d=>d.trim()):l==="true"?o[u]=!0:l==="false"?o[u]=!1:o[u]=l};return r.forEach(u=>{if(/^\s+/.test(u)&&!/^\s*\w+:/.test(u)&&i)a+=" "+u.trim();else{i&&a&&c(i,a);const[d,...f]=u.split(":");if(!d||d.trim()==="")return;i=d.trim(),a=f.join(":").trim()}}),i&&a&&c(i,a),{frontmatter:o,content:s}},Xd=()=>{const e=[];let t=1;return Object.entries(Qd).forEach(([n,s])=>{const{frontmatter:o,content:r}=Zd(s),i=n.split("/").pop().replace(".md","");e.push({id:t++,slug:i,title:o.title||i,description:o.description||"",coverImage:o.coverImage||null,accentColor:o.accentColor||"mauve",accentColorHex:Hr[o.accentColor]||Hr.mauve,tags:o.tags||[],url:o.url||null,github:o.github||null,status:o.status||"active",unlisted:o.unlisted===!0,content:r.trim()})}),e};let Un=null;const Cs=(e=!1)=>(Un||(Un=Xd()),(e?[...Un]:Un.filter(n=>!n.unlisted)).sort((n,s)=>n.title.localeCompare(s.title))),ep=e=>Cs(!0).find(t=>t.slug===e),tp=()=>{const e=new Set;return Cs().forEach(t=>{t.tags.forEach(n=>e.add(n))}),Array.from(e).sort()};function np(){return Cs().map(e=>({id:e.id,slug:e.slug,name:e.title,description:e.description,link:e.url||e.github||"#",screenshot:e.coverImage,accentColor:e.accentColorHex}))}const sp={class:"border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full"},op={key:0,class:"text-sm text-catppuccin-subtle"},rp={class:"lg:flex-1 lg:relative"},ip={key:0,class:"w-full flex-1 overflow-hidden bg-catppuccin-surface/30"},ap=["src","alt"],cp={class:"px-3 py-3 flex-shrink-0"},lp={class:"flex items-start gap-3"},up={class:"flex-1 min-w-0"},dp={class:"text-xs text-catppuccin-gray leading-relaxed"},pp={key:0,class:"flex justify-center gap-1.5 mt-3 flex-shrink-0"},fp=["onClick"],hp={__name:"ShowcaseCarousel",setup(e){const t=Nn(),n=pe([]),s=pe(0),o=pe(!1);let r=null;const i=re(()=>n.value.length?n.value[s.value]:null),a=c=>{t.push({path:"/projects",query:{project:c}})};return ut(()=>{n.value=np(),n.value.length>1&&(r=setInterval(()=>{o.value||(s.value=(s.value+1)%n.value.length)},1e4))}),$n(()=>{r&&clearInterval(r)}),(c,u)=>(C(),A("div",sp,[u[5]||(u[5]=g("div",{class:"text-catppuccin-subtle text-sm mb-3"},"~$ cat ~/showcase",-1)),n.value.length?(C(),A("div",{key:1,class:"relative lg:flex-1 flex flex-col",onMouseenter:u[2]||(u[2]=l=>o.value=!0),onMouseleave:u[3]||(u[3]=l=>o.value=!1)},[g("div",rp,[Q(Ln,{name:"showcase",mode:"out-in"},{default:Xe(()=>[i.value?(C(),A("div",{key:i.value.id,onClick:u[0]||(u[0]=l=>a(i.value.slug)),class:"group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all overflow-hidden border-catppuccin-surface/60 lg:absolute lg:inset-0 flex flex-col cursor-pointer",style:we({borderColor:`${i.value.accentColor}40`})},[i.value.screenshot?(C(),A("div",ip,[g("img",{src:i.value.screenshot,alt:i.value.name,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,ap)])):be("",!0),g("div",cp,[g("div",lp,[g("span",{class:"transition-colors",style:we({color:i.value.accentColor})},">",4),g("div",up,[g("h3",{class:"text-sm font-medium text-catppuccin-text transition-colors mb-1",style:we({color:i.value.accentColor})},G(i.value.name),5),g("p",dp,G(i.value.description),1)])])])],4)):be("",!0)]),_:1})]),n.value.length>1?(C(),A("div",pp,[(C(!0),A(ie,null,Se(n.value,(l,d)=>(C(),A("button",{key:`dot-${l.id}`,onClick:f=>s.value=d,class:$t(["w-2 h-2.5 rounded-full transition-all",d===s.value?"bg-catppuccin-mauve w-4":"bg-catppuccin-surface/60 hover:bg-catppuccin-surface"]),style:we(d===s.value?{backgroundColor:i.value.accentColor}:{})},null,14,fp))),128))])):be("",!0),g("button",{onClick:u[1]||(u[1]=l=>Le(t).push("/projects")),class:"mt-3 w-full py-2 px-3 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 text-sm text-catppuccin-subtle hover:text-catppuccin-mauve transition-all flex items-center justify-center gap-2"},[...u[4]||(u[4]=[g("span",null,"more projects",-1),g("span",null,"→",-1)])])],32)):(C(),A("div",op," no items to showcase "))]))}},mp=wt(hp,[["__scopeId","data-v-5e646ea4"]]),Io="hecker-01",Sa=async()=>{try{const e=[];let t=1;const n=100;for(;;){const r=await fetch(`https://api.github.com/users/${Io}/repos?per_page=${n}&page=${t}`);if(!r.ok)break;const i=await r.json();if(!i.length||(e.push(...i),i.length<n))break;t++}const s={};e.forEach(r=>{r.language&&(s[r.language]=(s[r.language]||0)+1)});const o=Object.entries(s).sort((r,i)=>i[1]-r[1]).map(([r,i])=>({language:r,count:i}));return{repos:e,languages:o,totalRepos:e.length}}catch(e){return console.error("Error fetching GitHub data:",e),{repos:[],languages:[],totalRepos:0}}},gp=async()=>{const t=new Date;t.getFullYear();try{const n=await fetch(`https://github-contributions-api.jogruber.de/v4/${Io}?y=last`);if(!n.ok)throw new Error("Failed to fetch contribution data");const s=await n.json(),o=[];if(s.contributions&&s.contributions.forEach(r=>{o.push({date:r.date,count:r.count})}),o.length>0){const i=new Date(t);i.setDate(i.getDate()-371+1);const a=[];for(let c=0;c<371;c++){const u=new Date(i);u.setDate(u.getDate()+c);const l=u.toISOString().split("T")[0],d=o.find(f=>f.date===l);a.push({date:l,count:d?d.count:0})}return a}throw new Error("No contributions data available")}catch(n){console.error("Error fetching contribution data:",n);const s=new Map;for(let o=370;o>=0;o--){const r=new Date(t);r.setDate(r.getDate()-o);const i=r.toISOString().split("T")[0];s.set(i,0)}return Array.from(s.entries()).sort((o,r)=>o[0].localeCompare(r[0])).map(([o,r])=>({date:o,count:r}))}},Hs=e=>e===0?0:e<=2?1:e<=5?2:e<=8?3:4,bp=e=>`https://github.com/${Io}?tab=overview&from=${e}&to=${e}`,vp={class:"mt-6 border-l-2 border-catppuccin-surface pl-4"},yp={class:"flex items-center justify-between mb-3"},xp={key:0,class:"flex items-center gap-1 text-[10px] text-catppuccin-subtle"},wp={key:0},_p={key:1},kp={class:"overflow-x-auto md:overflow-visible pb-2 md:pb-0 scrollbar-thin"},Cp={class:"inline-flex md:flex gap-[3px] md:gap-1",style:{"min-width":"max-content"}},Sp=["href","title"],Ap=["title"],Ep={class:"text-xs text-catppuccin-gray mt-2"},Tp={__name:"ContributionGraph",setup(e){const t=pe([]),n=pe(!0),s=re(()=>{const i=[];for(let a=0;a<t.value.length;a+=7)i.push(t.value.slice(a,a+7));return i}),o=re(()=>t.value.reduce((i,a)=>i+a.count,0)),r=async()=>{try{n.value=!0,t.value=await gp()}catch{}finally{n.value=!1}};return ut(()=>{r()}),(i,a)=>(C(),A("div",vp,[g("div",yp,[a[1]||(a[1]=g("div",{class:"text-catppuccin-subtle text-sm"},' ~$ git log --oneline --since="1.year.ago" | wc -l ',-1)),n.value?be("",!0):(C(),A("div",xp,[...a[0]||(a[0]=[Pn('<span>less</span><div class="flex gap-[1px]"><div class="w-2 h-2 rounded-[2px] bg-catppuccin-surface/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/30"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/70"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green"></div></div><span>more</span>',3)])]))]),n.value?(C(),A("div",wp,[...a[2]||(a[2]=[g("div",{class:"h-[60px] bg-catppuccin-surface/30 rounded cursor-blink"},null,-1)])])):(C(),A("div",_p,[g("div",kp,[g("div",Cp,[(C(!0),A(ie,null,Se(s.value,(c,u)=>(C(),A("div",{key:u,class:"flex flex-col gap-[3px] md:gap-1 md:flex-1"},[(C(!0),A(ie,null,Se(c,(l,d)=>(C(),A(ie,{key:d},[l.count>0?(C(),A("a",{key:0,href:Le(bp)(l.date),target:"_blank",rel:"noopener noreferrer",class:$t(["w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm transition-all hover:ring-1 hover:ring-catppuccin-green hover:scale-110 cursor-pointer",[Le(Hs)(l.count)===1?"bg-catppuccin-green/30 hover:bg-catppuccin-green/40":Le(Hs)(l.count)===2?"bg-catppuccin-green/50 hover:bg-catppuccin-green/60":Le(Hs)(l.count)===3?"bg-catppuccin-green/70 hover:bg-catppuccin-green/80":"bg-catppuccin-green hover:bg-catppuccin-green"]]),title:`${l.date}: ${l.count} contributions - Click to view on GitHub`},null,10,Sp)):(C(),A("div",{key:1,class:"w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm bg-catppuccin-surface/50",title:`${l.date}: ${l.count} contributions`},null,8,Ap))],64))),128))]))),128))])]),g("div",Ep,G(o.value)+" contributions in the last year ",1)]))]))}},Pp={class:"w-full py-8 text-center text-sm text-catppuccin-subtle dark:text-gray-400"},cn={__name:"Footer",setup(e){const t=new Date().getFullYear();return(n,s)=>(C(),A("footer",Pp,[g("p",null,"© 2020 - "+G(Le(t))+" heckr.dev | All rights reserved.",1)]))}},Rp={class:"border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full"},Dp={class:"lg:flex-1 flex flex-col"},Ip={key:0,class:"space-y-2"},Op={key:1,class:"text-sm text-catppuccin-subtle"},$p=["href"],Mp={class:"flex items-start gap-3 text-sm hover:text-catppuccin-mauve transition-colors px-3 py-2"},Lp={class:"flex-1 min-w-0"},Np={class:"flex items-center gap-2"},jp=["title"],Bp={key:0,class:"text-catppuccin-yellow text-xs flex-shrink-0"},Fp=["title"],Hp={key:3,class:"text-sm text-catppuccin-subtle"},Vp={__name:"ReposList",props:{repos:{type:Array,default:()=>[]},loading:{type:Boolean,default:!1}},setup(e){const t=e,n=re(()=>t.repos.length?[...t.repos].sort((s,o)=>o.stargazers_count-s.stargazers_count).slice(0,6):[]);return(s,o)=>(C(),A("div",Rp,[o[2]||(o[2]=g("div",{class:"text-catppuccin-subtle text-sm mb-3"},"~$ ls ~/repositories",-1)),g("div",Dp,[e.loading?(C(),A("div",Ip,[(C(),A(ie,null,Se(6,r=>g("div",{key:`repo-loading-${r}`,class:"rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 p-3"},[...o[0]||(o[0]=[Pn('<div class="flex items-start gap-3" data-v-effaf9c1><span class="text-catppuccin-subtle" data-v-effaf9c1>&gt;</span><div class="flex-1 min-w-0" data-v-effaf9c1><div class="h-3 bg-catppuccin-surface/70 rounded w-2/3 mb-2 cursor-blink" data-v-effaf9c1></div><div class="h-2 bg-catppuccin-surface/50 rounded w-1/3 cursor-blink" data-v-effaf9c1></div></div></div>',1)])])),64))])):e.repos.length?n.value.length?(C(),sn(Ul,{key:2,name:"list",tag:"div",class:"space-y-2"},{default:Xe(()=>[(C(!0),A(ie,null,Se(n.value,r=>(C(),A("a",{key:r.id,href:r.html_url,target:"_blank",class:"block group rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-colors"},[g("div",Mp,[o[1]||(o[1]=g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors"},">",-1)),g("div",Lp,[g("div",Np,[g("span",{class:"text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors font-medium truncate",title:r.name},G(r.name),9,jp),r.stargazers_count>0?(C(),A("span",Bp," ★"+G(r.stargazers_count),1)):be("",!0)]),g("p",{class:"text-xs text-catppuccin-gray truncate",title:r.description},G(r.description||"no description"),9,Fp)])])],8,$p))),128))]),_:1})):(C(),A("div",Hp," no repositories found ")):(C(),A("div",Op," no projects found "))])]))}},Up=wt(Vp,[["__scopeId","data-v-effaf9c1"]]),Wp={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Gp={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-16 md:pb-2"},qp={class:"grid lg:grid-cols-2 gap-6 lg:items-stretch"},Kp={__name:"Home",setup(e){const t=pe([]),n=pe(!0),s=pe([]),o=async()=>{try{n.value=!0;const{repos:r,languages:i}=await Sa("hecker-01");t.value=r,s.value=i}catch{}finally{n.value=!1}};return ut(()=>{o()}),(r,i)=>(C(),A("div",Wp,[g("div",Gp,[Q(Nd),Q(Ud,{languages:s.value,loading:n.value,id:"languages"},null,8,["languages","loading"]),g("div",qp,[Q(Up,{repos:t.value,loading:n.value},null,8,["repos","loading"]),Q(mp)]),Q(Tp),Q(cn)])]))}},Yp=`---
...
`)}_restoreDetailsBlocks(t,n){for(let s=n.detailsBlocks.length-1;s>=0;s--){const o=n.detailsBlocks[s],r=this.parse(o.content),i=`<details class="my-4 border border-catppuccin-surface rounded overflow-hidden">
      ...
      </div>`}_renderTable(t){const n=t[0],s=t.slice(2);let o='<div class="overflow-x-auto -mx-2 sm:mx-0 my-4"><table class="w-full text-sm border-collapse min-w-[400px]">';const r=n.split("|").filter(i=>i.trim());return o+="<thead><tr>",r.forEach(i=>{o+=`<th class="border border-catppuccin-surface px-3 py-2 text-left text-catppuccin-mauve bg-catppuccin-surface/30">${i.trim()}</th>`}),o+="</tr></thead>",o+="<tbody>",s.forEach(i=>{if(i.trim()&&!/^\|[\s\-:|]+\|$/.test(i)){const a=i.split("|").filter(c=>c.trim());o+="<tr>",a.forEach(c=>{o+=`<td class="border border-catppuccin-surface px-3 py-2 text-catppuccin-text">${c.trim()}</td>`}),o+="</tr>"}}),o+="</tbody></table></div>",o}_slugify(t){return t.toLowerCase().replace(/<[^>]*>/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}}const Ea=new Rf;class Df{highlightAll(){window.Prism&&(Prism.highlightAll(),document.querySelectorAll('pre[class*="language-"]').forEach(t=>{t.className=t.className.replace(/language-\S+/g,"").trim()}))}highlightAfterDelay(t=100){setTimeout(()=>this.highlightAll(),t)}}const as=new Df,If={class:"mb-8"},Of={class:"text-catppuccin-subtle text-sm mb-2"},$f={class:"text-3xl md:text-4xl font-bold text-catppuccin-mauve mb-3"},Mf={class:"flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-catppuccin-subtle mb-4"},Lf={class:"flex flex-wrap gap-2"},Nf={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},jf={class:"space-y-3"},Bf=["for"],Ff=["id","onUpdate:modelValue","placeholder"],Hf=["innerHTML"],Vf=["src","alt"],Vr=1,Uf=4,Wf={__name:"PostComponent",props:{post:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=re(()=>n.post.readingTime||1),i=pe({}),a=re(()=>is.extractVariables(n.post.content)),c=re(()=>is.substitute(n.post.content,i.value)),u=W=>Ea.parse(W),l=pe(null),d=pe(""),f=pe(1),m=pe(0),v=pe(0),k=re(()=>({transform:`translate(${m.value}px, ${v.value}px) scale(${f.value})`,transition:E?"none":"transform 0.2s ease"}));let E=!1,P=0,O=1,j=0,M=0,J=0,X=0,ee=0;const ue=()=>{f.value=1,m.value=0,v.value=0},B=W=>{const F=W[0].clientX-W[1].clientX,K=W[0].clientY-W[1].clientY;return Math.hypot(F,K)},Z=W=>{if(W.touches.length===2)E=!0,P=B(W.touches),O=f.value;else if(W.touches.length===1){const F=Date.now();if(F-ee<300){f.value>1?ue():f.value=2,ee=0;return}ee=F,J=W.touches[0].clientX,X=W.touches[0].clientY,j=m.value,M=v.value}},ae=W=>{if(W.touches.length===2){W.preventDefault();const F=B(W.touches),K=O*F/P;f.value=Math.min(Uf,Math.max(Vr,K))}else W.touches.length===1&&f.value>1&&(W.preventDefault(),m.value=j+(W.touches[0].clientX-J),v.value=M+(W.touches[0].clientY-X))},L=W=>{W.touches.length===0&&(E=!1,f.value<=Vr&&ue())},se=W=>{const F=W.target.closest("img");F&&(ue(),l.value=F.currentSrc||F.src,d.value=F.alt||"")},ye=()=>{l.value=null,d.value="",ue()},Ae=W=>{W.key==="Escape"&&l.value&&ye()};return ut(()=>{as.highlightAfterDelay(100),window.addEventListener("keydown",Ae)}),wo(()=>{window.removeEventListener("keydown",Ae)}),Dt(i,()=>{ms(()=>{as.highlightAll()})},{deep:!0}),(W,F)=>(C(),A("div",null,[g("div",If,[g("div",Of," ~$ cat "+G(e.post.slug)+".md ",1),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group"},[...F[1]||(F[1]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/posts",-1)])]),g("h1",$f,G(e.post.title),1),g("div",Mf,[g("span",null,G(e.post.date),1),F[2]||(F[2]=g("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),g("span",null,"~"+G(r.value)+" min read",1),F[3]||(F[3]=g("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),g("div",Lf,[(C(!0),A(ie,null,Se(e.post.tags,K=>(C(),A("span",{key:K,class:"text-catppuccin-gray"}," #"+G(K),1))),128))])])]),a.value.length>0?(C(),A("div",Nf,[F[4]||(F[4]=g("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),g("div",jf,[(C(!0),A(ie,null,Se(a.value,K=>(C(),A("div",{key:K,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[g("label",{for:`var-${K}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},G(K)+": ",9,Bf),wi(g("input",{id:`var-${K}`,"onUpdate:modelValue":Ye=>i.value[K]=Ye,type:"text",placeholder:K,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,Ff),[[pa,i.value[K]]])]))),128))])])):be("",!0),g("article",{class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden",onClick:se},[g("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:u(c.value)},null,8,Hf)]),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...F[5]||(F[5]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/posts",-1)])]),(C(),sn(wc,{to:"body"},[Q(Ln,{name:"lightbox-fade"},{default:Xe(()=>[l.value?(C(),A("div",{key:0,class:"fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[#000000] p-0 sm:bg-[#11111b]/80 sm:backdrop-blur-sm sm:p-4 cursor-zoom-out",onClick:ye},[g("button",{type:"button",class:"absolute top-4 right-4 z-10 w-10 h-10 flex items-center justify-center rounded-full border border-catppuccin-surface/60 bg-catppuccin-base/40 text-catppuccin-subtle hover:text-catppuccin-text hover:border-catppuccin-mauve/40 transition-colors","aria-label":"Close image",onClick:ye}," ✕ "),g("img",{src:l.value,alt:d.value,style:we(k.value),class:"max-w-full max-h-screen sm:max-h-[90vh] object-contain rounded-none sm:rounded-md shadow-2xl cursor-default touch-none select-none",onClick:F[0]||(F[0]=To(()=>{},["stop"])),onTouchstart:Z,onTouchmove:ae,onTouchend:L},null,44,Vf)])):be("",!0)]),_:1})]))]))}},Gf=wt(Wf,[["__scopeId","data-v-233a66c8"]]),qf={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Kf={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-16 md:pb-2"},Yf={key:"list"},zf={class:"mb-12"},Jf={class:"flex items-center gap-4 text-sm mb-6"},Qf={key:"post"},Zf={__name:"Posts",setup(e){const t=pe("list"),n=pe(null),s=pe(null),o=pe([]),r=pe([]),i=Do(),a=Nn(),c=re(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=Oo(),r.value=rf()},l=m=>{if(n.value=of(m),n.value)t.value="post",window.scrollTo({top:0,behavior:"instant"}),i.query.post!==m&&a.replace({name:"Posts",query:{...i.query,post:m}});else if(i.query.post){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"post"in i.query){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},f=m=>{s.value=s.value===m?null:m};return ut(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(k){const E=k.trigger,P=E.textContent;E.textContent="copied!",E.classList.add("text-catppuccin-green"),setTimeout(()=>{E.textContent=P,E.classList.remove("text-catppuccin-green")},2e3),k.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.post;v&&l(v)}),$n(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),Dt(()=>i.query.post,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="post"&&d({skipQueryUpdate:!0})}),(m,v)=>{const k=vs("router-link");return C(),A("div",qf,[g("div",Kf,[Q(Ln,{name:"fade",mode:"out-in"},{default:Xe(()=>[t.value==="list"?(C(),A("div",Yf,[g("div",zf,[v[1]||(v[1]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"},"~$ cd ~/posts",-1)),g("div",Jf,[Q(k,{to:"/",class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},{default:Xe(()=>[...v[0]||(v[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])]),_:1})]),v[2]||(v[2]=g("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[g("span",{class:"text-catppuccin-mauve"},"Posts")],-1)),v[3]||(v[3]=g("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," My thoughts, tutorials, and experiences on various topics including web development, programming, and technology. ",-1)),Q(Aa,{tags:r.value,"selected-tag":s.value,onToggleTag:f},null,8,["tags","selected-tag"])]),Q(Ef,{posts:c.value,"selected-tag":s.value,onOpenPost:l,onSelectTag:f},null,8,["posts","selected-tag"]),Q(cn)])):t.value==="post"&&n.value?(C(),A("div",Qf,[Q(Gf,{post:n.value,onGoBack:d},null,8,["post"]),Q(cn)])):be("",!0)]),_:1})])])}}},Xf=wt(Zf,[["__scopeId","data-v-68ab2d75"]]),eh={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2"},th={class:"text-catppuccin-subtle text-sm mb-3"},nh={key:0,class:"text-catppuccin-mauve"},sh={key:0,class:"text-sm text-catppuccin-subtle"},oh={key:1,class:"grid gap-4 sm:grid-cols-2"},rh=["onClick"],ih={key:0,class:"w-full h-32 sm:h-40 overflow-hidden bg-catppuccin-surface/30"},ah=["src","alt"],ch={class:"px-3 sm:px-4 py-3"},lh={class:"flex items-start gap-2 mb-2"},uh={class:"text-sm text-catppuccin-gray mb-3 leading-relaxed line-clamp-2"},dh={class:"flex items-center gap-2 flex-wrap"},ph=["onClick"],fh={key:0,class:"text-xs text-catppuccin-subtle"},hh={__name:"ProjectList",props:{projects:{type:Array,default:()=>[]},selectedTag:{type:String,default:null}},emits:["open-project","select-tag"],setup(e,{emit:t}){const n=t,s=o=>{n("open-project",o)};return(o,r)=>(C(),A("div",eh,[g("div",th,[r[0]||(r[0]=Me(" ~$ ls -la projects/ ",-1)),e.selectedTag?(C(),A("span",nh,'| grep "'+G(e.selectedTag)+'"',1)):be("",!0)]),e.projects.length?(C(),A("div",oh,[(C(!0),A(ie,null,Se(e.projects,i=>(C(),A("div",{key:i.id,onClick:a=>s(i.slug),class:"block group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all cursor-pointer overflow-hidden",style:we({borderColor:`${i.accentColorHex}40`})},[i.coverImage?(C(),A("div",ih,[g("img",{src:i.coverImage,alt:i.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,ah)])):be("",!0),g("div",ch,[g("div",lh,[g("span",{class:"text-sm transition-colors",style:we({color:i.accentColorHex})},">",4),g("h2",{class:"text-base font-semibold text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors",style:we({"--hover-color":i.accentColorHex})},G(i.title),5)]),g("p",uh,G(i.description),1),g("div",dh,[(C(!0),A(ie,null,Se(i.tags.slice(0,3),a=>(C(),A("span",{key:a,onClick:To(c=>n("select-tag",a),["stop"]),class:"px-2 py-1 sm:py-0.5 rounded text-xs bg-catppuccin-surface/60 text-catppuccin-subtle hover:text-catppuccin-mauve cursor-pointer transition-colors",style:we({"--hover-bg":`${i.accentColorHex}20`})}," #"+G(a),13,ph))),128)),i.tags.length>3?(C(),A("span",fh," +"+G(i.tags.length-3),1)):be("",!0),g("span",{class:"ml-auto text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors text-sm",style:we({"--hover-color":i.accentColorHex})}," view → ",4)])])],12,rh))),128))])):(C(),A("div",sh," no projects found "))]))}},mh=wt(hh,[["__scopeId","data-v-b7be8c48"]]),gh={class:"mb-8"},bh={class:"text-catppuccin-subtle text-sm mb-2"},vh=["src","alt"],yh={class:"flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-catppuccin-subtle mb-4"},xh={class:"flex flex-wrap gap-2"},wh={class:"flex flex-wrap gap-3 mb-6"},_h=["href"],kh=["href"],Ch={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},Sh={class:"space-y-3"},Ah=["for"],Eh=["id","onUpdate:modelValue","placeholder"],Th={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden"},Ph=["innerHTML"],Rh={__name:"ProjectComponent",props:{project:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=pe({}),i=re(()=>is.extractVariables(n.project.content)),a=re(()=>is.substitute(n.project.content,r.value)),c=u=>Ea.parse(u);return ut(()=>{as.highlightAfterDelay(100)}),Dt(r,()=>{ms(()=>{as.highlightAll()})},{deep:!0}),(u,l)=>(C(),A("div",{style:we({"--accent-color":e.project.accentColorHex})},[g("div",gh,[g("div",bh," ~$ cat "+G(e.project.slug)+".md ",1),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group"},[...l[0]||(l[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/projects",-1)])]),e.project.coverImage?(C(),A("div",{key:0,class:"w-full h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden mb-6 border",style:we({borderColor:`${e.project.accentColorHex}40`})},[g("img",{src:e.project.coverImage,alt:e.project.title,class:"w-full h-full object-cover"},null,8,vh)],4)):be("",!0),g("h1",{class:"text-3xl md:text-4xl font-bold mb-3",style:we({color:e.project.accentColorHex})},G(e.project.title),5),g("div",yh,[g("span",{class:$t(["px-2 py-0.5 rounded text-xs capitalize",{"bg-catppuccin-green/20 text-catppuccin-green":e.project.status==="active","bg-catppuccin-yellow/20 text-catppuccin-yellow":e.project.status==="in-progress","bg-catppuccin-red/20 text-catppuccin-red":e.project.status==="archived","bg-catppuccin-blue/20 text-catppuccin-blue":e.project.status==="beta","bg-catppuccin-peach/20 text-catppuccin-peach":e.project.status==="stale"}])},G(e.project.status),3),g("div",xh,[(C(!0),A(ie,null,Se(e.project.tags,d=>(C(),A("span",{key:d,class:"text-catppuccin-gray"}," #"+G(d),1))),128))])]),g("div",wh,[e.project.url?(C(),A("a",{key:0,href:e.project.url,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border text-sm transition-colors hover:bg-catppuccin-surface/30",style:we({borderColor:`${e.project.accentColorHex}60`,color:e.project.accentColorHex})},[...l[1]||(l[1]=[g("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[g("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})],-1),Me(" Live Site ",-1)])],12,_h)):be("",!0),e.project.github?(C(),A("a",{key:1,href:e.project.github,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border border-catppuccin-surface/60 text-sm text-catppuccin-subtle transition-colors hover:bg-catppuccin-surface/30 hover:text-catppuccin-text"},[...l[2]||(l[2]=[g("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24"},[g("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})],-1),Me(" GitHub ",-1)])],8,kh)):be("",!0)])]),i.value.length>0?(C(),A("div",Ch,[l[3]||(l[3]=g("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),g("div",Sh,[(C(!0),A(ie,null,Se(i.value,d=>(C(),A("div",{key:d,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[g("label",{for:`var-${d}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},G(d)+": ",9,Ah),wi(g("input",{id:`var-${d}`,"onUpdate:modelValue":f=>r.value[d]=f,type:"text",placeholder:d,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,Eh),[[pa,r.value[d]]])]))),128))])])):be("",!0),g("article",Th,[g("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:c(a.value)},null,8,Ph)]),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...l[4]||(l[4]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/projects",-1)])])],4))}},Dh=wt(Rh,[["__scopeId","data-v-b3acbc76"]]),Ih={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Oh={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:pt-16 md:pb-2"},$h={key:"list"},Mh={class:"mb-12"},Lh={class:"flex items-center gap-4 text-sm mb-6"},Nh={key:"project"},jh={__name:"Projects",setup(e){const t=pe("list"),n=pe(null),s=pe(null),o=pe([]),r=pe([]),i=Do(),a=Nn(),c=re(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=Cs(),r.value=tp()},l=m=>{if(n.value=ep(m),n.value)t.value="project",window.scrollTo({top:0,behavior:"instant"}),i.query.project!==m&&a.replace({name:"Projects",query:{...i.query,project:m}});else if(i.query.project){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"project"in i.query){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},f=m=>{s.value=s.value===m?null:m};return ut(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(k){const E=k.trigger,P=E.textContent;E.textContent="copied!",E.classList.add("text-catppuccin-green"),setTimeout(()=>{E.textContent=P,E.classList.remove("text-catppuccin-green")},2e3),k.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.project;v&&l(v)}),$n(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),Dt(()=>i.query.project,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="project"&&d({skipQueryUpdate:!0})}),(m,v)=>{const k=vs("router-link");return C(),A("div",Ih,[g("div",Oh,[Q(Ln,{name:"fade",mode:"out-in"},{default:Xe(()=>[t.value==="list"?(C(),A("div",$h,[g("div",Mh,[v[1]||(v[1]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"}," ~$ cd ~/projects ",-1)),g("div",Lh,[Q(k,{to:"/",class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},{default:Xe(()=>[...v[0]||(v[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])]),_:1})]),v[2]||(v[2]=g("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[g("span",{class:"text-catppuccin-mauve"},"Projects")],-1)),v[3]||(v[3]=g("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," A collection of projects I've worked on, ranging from web applications to plugins and tools. ",-1)),Q(Aa,{tags:r.value,"selected-tag":s.value,onToggleTag:f},null,8,["tags","selected-tag"])]),Q(mh,{projects:c.value,"selected-tag":s.value,onOpenProject:l,onSelectTag:f},null,8,["projects","selected-tag"]),Q(cn)])):t.value==="project"&&n.value?(C(),A("div",Nh,[Q(Dh,{project:n.value,onGoBack:d},null,8,["project"]),Q(cn)])):be("",!0)]),_:1})])])}}},Bh=wt(jh,[["__scopeId","data-v-b2095279"]]),Fh={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Hh={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-16"},Vh={class:"mb-8"},Uh={class:"text-catppuccin-subtle text-sm mb-4"},Wh={class:"border-l-2 border-catppuccin-surface pl-4"},Gh={class:"text-catppuccin-red text-sm"},qh={class:"text-catppuccin-mauve"},Kh={__name:"NotFound",setup(e){const t=Do(),n=Nn(),s=re(()=>(t.fullPath||t.path||"/").replace(/^\//,"")||"."),o=()=>n.push("/");return(r,i)=>(C(),A("div",Fh,[g("div",Hh,[g("div",Vh,[g("div",Uh," ~$ cd ~/"+G(s.value),1),g("div",{class:"flex items-center gap-4 text-sm mb-6"},[g("button",{onClick:o,class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...i[0]||(i[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])])])]),g("div",Wh,[g("div",Gh,[i[1]||(i[1]=Me(" cd: no such file or directory: /",-1)),g("span",qh,G(s.value),1)])])]),Q(cn)]))}},Yh=[{path:"/",name:"Home",component:Kp,meta:{title:"Home | heckr.dev"}},{path:"/posts",name:"Posts",component:Xf,meta:{title:"Posts | heckr.dev"}},{path:"/projects",name:"Projects",component:Bh,meta:{title:"Projects | heckr.dev"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:Kh,meta:{title:"404 Not Found | heckr.dev"}}],Ta=ad({history:Bu(),routes:Yh,scrollBehavior(e,t,n){return n||{top:0}}});Ta.beforeEach((e,t,n)=>{document.title=e.meta.title||"heckr.dev",n()});let fn=0;const Ur=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","KeyB","KeyA"],zh=()=>{console.log("%cWelcome to heckr.dev","font-size: 20px; font-weight: bold; color: #cba6f7;"),console.log("%cWelcome to the dev console, here are some commands to try:","font-size: 14px; color: #a6adc8;"),console.log(`%c- help() - show available commands
...
Feel free to reach out!`,"font-size: 12px; color: #a6adc8;")},window.secret=()=>{console.log("%cYou found the secret command","font-size: 18px; font-weight: bold; color: #f9e2af;"),console.log("%cHere's a hint: ↑ ↑ ↓ ↓ ← → ← → B A","font-size: 12px; color: #fab387;")},document.addEventListener("keydown",e=>{e.code===Ur[fn]?(fn++,fn===Ur.length&&(Jh(),fn=0)):fn=0})},Jh=()=>{if(console.log("%cKONAMI CODE ACTIVATED!","font-size: 24px; font-weight: bold; color: #f9e2af; text-shadow: 2px 2px 4px #000;"),document.body.style.animation="rainbow-border 2s linear infinite",!document.getElementById("konami-style")){const e=document.createElement("style");e.id="konami-style",e.textContent=`
    ...
    `,document.head.appendChild(e)}setTimeout(()=>{document.body.style.animation=""},5e3)};Xl(cd).use(Ta).mount("#app");zh();
