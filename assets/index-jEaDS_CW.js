...
`,Ir={mauve:"#cba6f7",blue:"#89b4fa",green:"#a6e3a1",red:"#f38ba8",pink:"#f5c2e7",yellow:"#f9e2af",teal:"#94e2d5",sapphire:"#74c7ec",sky:"#89dceb",lavender:"#b4befe",peach:"#fab387",maroon:"#eba0ac",flamingo:"#f2cdcd"},Bd=Object.assign({"/projects/mcbe-pack-decryptor.md":Dd,"/projects/pingr.md":Od,"/projects/portfolio.md":$d,"/projects/recodr.md":Md,"/projects/satissuite.md":Ld,"/projects/wordr.md":Nd,"/projects/yume-ramen.md":jd}),Fd=e=>{const t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n([\s\S]*)$/);if(!t)return{frontmatter:{},content:e};const[,n,s]=t,o={},r=n.split(`
`);let i=null,a="";const c=(u,l)=>{l=l.trim(),l.startsWith("[")&&l.endsWith("]")?o[u]=l.slice(1,-1).split(",").map(d=>d.trim()):l==="true"?o[u]=!0:l==="false"?o[u]=!1:o[u]=l};return r.forEach(u=>{if(/^\s+/.test(u)&&!/^\s*\w+:/.test(u)&&i)a+=" "+u.trim();else{i&&a&&c(i,a);const[d,...f]=u.split(":");if(!d||d.trim()==="")return;i=d.trim(),a=f.join(":").trim()}}),i&&a&&c(i,a),{frontmatter:o,content:s}},Hd=()=>{const e=[];let t=1;return Object.entries(Bd).forEach(([n,s])=>{const{frontmatter:o,content:r}=Fd(s),i=n.split("/").pop().replace(".md","");e.push({id:t++,slug:i,title:o.title||i,description:o.description||"",coverImage:o.coverImage||null,accentColor:o.accentColor||"mauve",accentColorHex:Ir[o.accentColor]||Ir.mauve,tags:o.tags||[],url:o.url||null,github:o.github||null,status:o.status||"active",unlisted:o.unlisted===!0,content:r.trim()})}),e};let Fn=null;const ws=(e=!1)=>(Fn||(Fn=Hd()),(e?[...Fn]:Fn.filter(n=>!n.unlisted)).sort((n,s)=>n.title.localeCompare(s.title))),Vd=e=>ws(!0).find(t=>t.slug===e),Ud=()=>{const e=new Set;return ws().forEach(t=>{t.tags.forEach(n=>e.add(n))}),Array.from(e).sort()};function Wd(){return ws().map(e=>({id:e.id,slug:e.slug,name:e.title,description:e.description,link:e.url||e.github||"#",screenshot:e.coverImage,accentColor:e.accentColorHex}))}const Gd={class:"border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full"},qd={key:0,class:"text-sm text-catppuccin-subtle"},Kd={class:"lg:flex-1 lg:relative"},zd={key:0,class:"w-full flex-1 overflow-hidden bg-catppuccin-surface/30"},Yd=["src","alt"],Jd={class:"px-3 py-3 flex-shrink-0"},Qd={class:"flex items-start gap-3"},Zd={class:"flex-1 min-w-0"},Xd={class:"text-xs text-catppuccin-gray leading-relaxed"},ep={key:0,class:"flex justify-center gap-1.5 mt-3 flex-shrink-0"},tp=["onClick"],np={__name:"ShowcaseCarousel",setup(e){const t=Mn(),n=me([]),s=me(0),o=me(!1);let r=null;const i=ee(()=>n.value.length?n.value[s.value]:null),a=c=>{t.push({path:"/projects",query:{project:c}})};return lt(()=>{n.value=Wd(),n.value.length>1&&(r=setInterval(()=>{o.value||(s.value=(s.value+1)%n.value.length)},1e4))}),On(()=>{r&&clearInterval(r)}),(c,u)=>(C(),S("div",Gd,[u[5]||(u[5]=g("div",{class:"text-catppuccin-subtle text-sm mb-3"},"~$ cat ~/showcase",-1)),n.value.length?(C(),S("div",{key:1,class:"relative lg:flex-1 flex flex-col",onMouseenter:u[2]||(u[2]=l=>o.value=!0),onMouseleave:u[3]||(u[3]=l=>o.value=!1)},[g("div",Kd,[K(vs,{name:"showcase",mode:"out-in"},{default:ct(()=>[i.value?(C(),S("div",{key:i.value.id,onClick:u[0]||(u[0]=l=>a(i.value.slug)),class:"group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all overflow-hidden border-catppuccin-surface/60 lg:absolute lg:inset-0 flex flex-col cursor-pointer",style:ye({borderColor:`${i.value.accentColor}40`})},[i.value.screenshot?(C(),S("div",zd,[g("img",{src:i.value.screenshot,alt:i.value.name,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,Yd)])):he("",!0),g("div",Jd,[g("div",Qd,[g("span",{class:"transition-colors",style:ye({color:i.value.accentColor})},">",4),g("div",Zd,[g("h3",{class:"text-sm font-medium text-catppuccin-text transition-colors mb-1",style:ye({color:i.value.accentColor})},V(i.value.name),5),g("p",Xd,V(i.value.description),1)])])])],4)):he("",!0)]),_:1})]),n.value.length>1?(C(),S("div",ep,[(C(!0),S(Z,null,Ce(n.value,(l,d)=>(C(),S("button",{key:`dot-${l.id}`,onClick:f=>s.value=d,class:$t(["w-2 h-2.5 rounded-full transition-all",d===s.value?"bg-catppuccin-mauve w-4":"bg-catppuccin-surface/60 hover:bg-catppuccin-surface"]),style:ye(d===s.value?{backgroundColor:i.value.accentColor}:{})},null,14,tp))),128))])):he("",!0),g("button",{onClick:u[1]||(u[1]=l=>Oe(t).push("/projects")),class:"mt-3 w-full py-2 px-3 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 text-sm text-catppuccin-subtle hover:text-catppuccin-mauve transition-all flex items-center justify-center gap-2"},[...u[4]||(u[4]=[g("span",null,"more projects",-1),g("span",null,"→",-1)])])],32)):(C(),S("div",qd," no items to showcase "))]))}},sp=wt(np,[["__scopeId","data-v-5e646ea4"]]),So="hecker-01",ha=async()=>{try{const e=[];let t=1;const n=100;for(;;){const r=await fetch(`https://api.github.com/users/${So}/repos?per_page=${n}&page=${t}`);if(!r.ok)break;const i=await r.json();if(!i.length||(e.push(...i),i.length<n))break;t++}const s={};e.forEach(r=>{r.language&&(s[r.language]=(s[r.language]||0)+1)});const o=Object.entries(s).sort((r,i)=>i[1]-r[1]).map(([r,i])=>({language:r,count:i}));return{repos:e,languages:o,totalRepos:e.length}}catch(e){return console.error("Error fetching GitHub data:",e),{repos:[],languages:[],totalRepos:0}}},op=async()=>{const t=new Date;t.getFullYear();try{const n=await fetch(`https://github-contributions-api.jogruber.de/v4/${So}?y=last`);if(!n.ok)throw new Error("Failed to fetch contribution data");const s=await n.json(),o=[];if(s.contributions&&s.contributions.forEach(r=>{o.push({date:r.date,count:r.count})}),o.length>0){const i=new Date(t);i.setDate(i.getDate()-371+1);const a=[];for(let c=0;c<371;c++){const u=new Date(i);u.setDate(u.getDate()+c);const l=u.toISOString().split("T")[0],d=o.find(f=>f.date===l);a.push({date:l,count:d?d.count:0})}return a}throw new Error("No contributions data available")}catch(n){console.error("Error fetching contribution data:",n);const s=new Map;for(let o=370;o>=0;o--){const r=new Date(t);r.setDate(r.getDate()-o);const i=r.toISOString().split("T")[0];s.set(i,0)}return Array.from(s.entries()).sort((o,r)=>o[0].localeCompare(r[0])).map(([o,r])=>({date:o,count:r}))}},js=e=>e===0?0:e<=2?1:e<=5?2:e<=8?3:4,rp=e=>`https://github.com/${So}?tab=overview&from=${e}&to=${e}`,ip={class:"mt-6 border-l-2 border-catppuccin-surface pl-4"},ap={class:"flex items-center justify-between mb-3"},cp={key:0,class:"flex items-center gap-1 text-[10px] text-catppuccin-subtle"},lp={key:0},up={key:1},dp={class:"overflow-x-auto md:overflow-visible pb-2 md:pb-0 scrollbar-thin"},pp={class:"inline-flex md:flex gap-[3px] md:gap-1",style:{"min-width":"max-content"}},fp=["href","title"],hp=["title"],mp={class:"text-xs text-catppuccin-gray mt-2"},gp={__name:"ContributionGraph",setup(e){const t=me([]),n=me(!0),s=ee(()=>{const i=[];for(let a=0;a<t.value.length;a+=7)i.push(t.value.slice(a,a+7));return i}),o=ee(()=>t.value.reduce((i,a)=>i+a.count,0)),r=async()=>{try{n.value=!0,t.value=await op()}catch{}finally{n.value=!1}};return lt(()=>{r()}),(i,a)=>(C(),S("div",ip,[g("div",ap,[a[1]||(a[1]=g("div",{class:"text-catppuccin-subtle text-sm"},' ~$ git log --oneline --since="1.year.ago" | wc -l ',-1)),n.value?he("",!0):(C(),S("div",cp,[...a[0]||(a[0]=[Pn('<span>less</span><div class="flex gap-[1px]"><div class="w-2 h-2 rounded-[2px] bg-catppuccin-surface/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/30"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/50"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green/70"></div><div class="w-2 h-2 rounded-[2px] bg-catppuccin-green"></div></div><span>more</span>',3)])]))]),n.value?(C(),S("div",lp,[...a[2]||(a[2]=[g("div",{class:"h-[60px] bg-catppuccin-surface/30 rounded cursor-blink"},null,-1)])])):(C(),S("div",up,[g("div",dp,[g("div",pp,[(C(!0),S(Z,null,Ce(s.value,(c,u)=>(C(),S("div",{key:u,class:"flex flex-col gap-[3px] md:gap-1 md:flex-1"},[(C(!0),S(Z,null,Ce(c,(l,d)=>(C(),S(Z,{key:d},[l.count>0?(C(),S("a",{key:0,href:Oe(rp)(l.date),target:"_blank",rel:"noopener noreferrer",class:$t(["w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm transition-all hover:ring-1 hover:ring-catppuccin-green hover:scale-110 cursor-pointer",[Oe(js)(l.count)===1?"bg-catppuccin-green/30 hover:bg-catppuccin-green/40":Oe(js)(l.count)===2?"bg-catppuccin-green/50 hover:bg-catppuccin-green/60":Oe(js)(l.count)===3?"bg-catppuccin-green/70 hover:bg-catppuccin-green/80":"bg-catppuccin-green hover:bg-catppuccin-green"]]),title:`${l.date}: ${l.count} contributions - Click to view on GitHub`},null,10,fp)):(C(),S("div",{key:1,class:"w-[10px] h-[10px] md:w-auto md:h-auto md:aspect-square rounded-sm bg-catppuccin-surface/50",title:`${l.date}: ${l.count} contributions`},null,8,hp))],64))),128))]))),128))])]),g("div",mp,V(o.value)+" contributions in the last year ",1)]))]))}},bp={class:"w-full py-8 text-center text-sm text-catppuccin-subtle dark:text-gray-400"},an={__name:"Footer",setup(e){const t=new Date().getFullYear();return(n,s)=>(C(),S("footer",bp,[g("p",null,"© 2020 - "+V(Oe(t))+" heckr.dev | All rights reserved.",1)]))}},vp={class:"border-l-2 border-catppuccin-surface pl-4 min-w-0 flex flex-col lg:h-full"},yp={class:"lg:flex-1 flex flex-col"},xp={key:0,class:"space-y-2"},wp={key:1,class:"text-sm text-catppuccin-subtle"},_p=["href"],kp={class:"flex items-start gap-3 text-sm hover:text-catppuccin-mauve transition-colors px-3 py-2"},Cp={class:"flex-1 min-w-0"},Sp={class:"flex items-center gap-2"},Ep=["title"],Ap={key:0,class:"text-catppuccin-yellow text-xs flex-shrink-0"},Pp=["title"],Tp={key:3,class:"text-sm text-catppuccin-subtle"},Rp={__name:"ReposList",props:{repos:{type:Array,default:()=>[]},loading:{type:Boolean,default:!1}},setup(e){const t=e,n=ee(()=>t.repos.length?[...t.repos].sort((s,o)=>o.stargazers_count-s.stargazers_count).slice(0,6):[]);return(s,o)=>(C(),S("div",vp,[o[2]||(o[2]=g("div",{class:"text-catppuccin-subtle text-sm mb-3"},"~$ ls ~/repositories",-1)),g("div",yp,[e.loading?(C(),S("div",xp,[(C(),S(Z,null,Ce(6,r=>g("div",{key:`repo-loading-${r}`,class:"rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 p-3"},[...o[0]||(o[0]=[Pn('<div class="flex items-start gap-3" data-v-effaf9c1><span class="text-catppuccin-subtle" data-v-effaf9c1>&gt;</span><div class="flex-1 min-w-0" data-v-effaf9c1><div class="h-3 bg-catppuccin-surface/70 rounded w-2/3 mb-2 cursor-blink" data-v-effaf9c1></div><div class="h-2 bg-catppuccin-surface/50 rounded w-1/3 cursor-blink" data-v-effaf9c1></div></div></div>',1)])])),64))])):e.repos.length?n.value.length?(C(),An(Il,{key:2,name:"list",tag:"div",class:"space-y-2"},{default:ct(()=>[(C(!0),S(Z,null,Ce(n.value,r=>(C(),S("a",{key:r.id,href:r.html_url,target:"_blank",class:"block group rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-colors"},[g("div",kp,[o[1]||(o[1]=g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors"},">",-1)),g("div",Cp,[g("div",Sp,[g("span",{class:"text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors font-medium truncate",title:r.name},V(r.name),9,Ep),r.stargazers_count>0?(C(),S("span",Ap," ★"+V(r.stargazers_count),1)):he("",!0)]),g("p",{class:"text-xs text-catppuccin-gray truncate",title:r.description},V(r.description||"no description"),9,Pp)])])],8,_p))),128))]),_:1})):(C(),S("div",Tp," no repositories found ")):(C(),S("div",wp," no projects found "))])]))}},Ip=wt(Rp,[["__scopeId","data-v-effaf9c1"]]),Dp={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Op={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},$p={class:"grid lg:grid-cols-2 gap-6 lg:items-stretch"},Mp={__name:"Home",setup(e){const t=me([]),n=me(!0),s=me([]),o=async()=>{try{n.value=!0;const{repos:r,languages:i}=await ha("hecker-01");t.value=r,s.value=i}catch{}finally{n.value=!1}};return lt(()=>{o()}),(r,i)=>(C(),S("div",Dp,[g("div",Op,[K(Sd),K(Id,{languages:s.value,loading:n.value},null,8,["languages","loading"]),g("div",$p,[K(Ip,{repos:t.value,loading:n.value},null,8,["repos","loading"]),K(sp)]),K(gp),K(an)])]))}},Lp=`---
...
`)}_restoreDetailsBlocks(t,n){for(let s=n.detailsBlocks.length-1;s>=0;s--){const o=n.detailsBlocks[s],r=this.parse(o.content),i=`<details class="my-4 border border-catppuccin-surface rounded overflow-hidden">
      ...
      </div>`}_renderTable(t){const n=t[0],s=t.slice(2);let o='<div class="overflow-x-auto -mx-2 sm:mx-0 my-4"><table class="w-full text-sm border-collapse min-w-[400px]">';const r=n.split("|").filter(i=>i.trim());return o+="<thead><tr>",r.forEach(i=>{o+=`<th class="border border-catppuccin-surface px-3 py-2 text-left text-catppuccin-mauve bg-catppuccin-surface/30">${i.trim()}</th>`}),o+="</tr></thead>",o+="<tbody>",s.forEach(i=>{if(i.trim()&&!/^\|[\s\-:|]+\|$/.test(i)){const a=i.split("|").filter(c=>c.trim());o+="<tr>",a.forEach(c=>{o+=`<td class="border border-catppuccin-surface px-3 py-2 text-catppuccin-text">${c.trim()}</td>`}),o+="</tr>"}}),o+="</tbody></table></div>",o}_slugify(t){return t.toLowerCase().replace(/<[^>]*>/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}}const ga=new bf;class vf{highlightAll(){window.Prism&&(Prism.highlightAll(),document.querySelectorAll('pre[class*="language-"]').forEach(t=>{t.className=t.className.replace(/language-\S+/g,"").trim()}))}highlightAfterDelay(t=100){setTimeout(()=>this.highlightAll(),t)}}const ss=new vf,yf={class:"mb-8"},xf={class:"text-catppuccin-subtle text-sm mb-2"},wf={class:"text-3xl md:text-4xl font-bold text-catppuccin-mauve mb-3"},_f={class:"flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-catppuccin-subtle mb-4"},kf={class:"flex flex-wrap gap-2"},Cf={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},Sf={class:"space-y-3"},Ef=["for"],Af=["id","onUpdate:modelValue","placeholder"],Pf={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden"},Tf=["innerHTML"],Rf={__name:"PostComponent",props:{post:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=ee(()=>n.post.readingTime||1),i=me({}),a=ee(()=>ns.extractVariables(n.post.content)),c=ee(()=>ns.substitute(n.post.content,i.value)),u=l=>ga.parse(l);return lt(()=>{ss.highlightAfterDelay(100)}),It(i,()=>{ds(()=>{ss.highlightAll()})},{deep:!0}),(l,d)=>(C(),S("div",null,[g("div",yf,[g("div",xf," ~$ cat "+V(e.post.slug)+".md ",1),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group"},[...d[0]||(d[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/posts",-1)])]),g("h1",wf,V(e.post.title),1),g("div",_f,[g("span",null,V(e.post.date),1),d[1]||(d[1]=g("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),g("span",null,"~"+V(r.value)+" min read",1),d[2]||(d[2]=g("span",{class:"hidden sm:inline text-catppuccin-surface"},"•",-1)),g("div",kf,[(C(!0),S(Z,null,Ce(e.post.tags,f=>(C(),S("span",{key:f,class:"text-catppuccin-gray"}," #"+V(f),1))),128))])])]),a.value.length>0?(C(),S("div",Cf,[d[3]||(d[3]=g("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),g("div",Sf,[(C(!0),S(Z,null,Ce(a.value,f=>(C(),S("div",{key:f,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[g("label",{for:`var-${f}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},V(f)+": ",9,Ef),ui(g("input",{id:`var-${f}`,"onUpdate:modelValue":m=>i.value[f]=m,type:"text",placeholder:f,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,Af),[[ea,i.value[f]]])]))),128))])])):he("",!0),g("article",Pf,[g("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:u(c.value)},null,8,Tf)]),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...d[4]||(d[4]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/posts",-1)])])]))}},If=wt(Rf,[["__scopeId","data-v-c0ce7b1a"]]),Df={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Of={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},$f={key:"list"},Mf={class:"mb-12"},Lf={class:"flex items-center gap-4 text-sm mb-6"},Nf={key:"post"},jf={__name:"Posts",setup(e){const t=me("list"),n=me(null),s=me(null),o=me([]),r=me([]),i=Co(),a=Mn(),c=ee(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=Eo(),r.value=qp()},l=m=>{if(n.value=Gp(m),n.value)t.value="post",window.scrollTo({top:0,behavior:"instant"}),i.query.post!==m&&a.replace({name:"Posts",query:{...i.query,post:m}});else if(i.query.post){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"post"in i.query){const v={...i.query};delete v.post,a.replace({name:"Posts",query:v})}},f=m=>{s.value=s.value===m?null:m};return lt(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(A){const L=A.trigger,I=L.textContent;L.textContent="copied!",L.classList.add("text-catppuccin-green"),setTimeout(()=>{L.textContent=I,L.classList.remove("text-catppuccin-green")},2e3),A.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.post;v&&l(v)}),On(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),It(()=>i.query.post,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="post"&&d({skipQueryUpdate:!0})}),(m,v)=>{const A=hs("router-link");return C(),S("div",Df,[g("div",Of,[K(vs,{name:"fade",mode:"out-in"},{default:ct(()=>[t.value==="list"?(C(),S("div",$f,[g("div",Mf,[v[1]||(v[1]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"},"~$ cd ~/posts",-1)),g("div",Lf,[K(A,{to:"/",class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},{default:ct(()=>[...v[0]||(v[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])]),_:1})]),v[2]||(v[2]=g("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[g("span",{class:"text-catppuccin-mauve"},"Posts")],-1)),v[3]||(v[3]=g("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," My thoughts, tutorials, and experiences on various topics including web development, programming, and technology. ",-1)),K(ma,{tags:r.value,"selected-tag":s.value,onToggleTag:f},null,8,["tags","selected-tag"])]),K(hf,{posts:c.value,"selected-tag":s.value,onOpenPost:l,onSelectTag:f},null,8,["posts","selected-tag"]),K(an)])):t.value==="post"&&n.value?(C(),S("div",Nf,[K(If,{post:n.value,onGoBack:d},null,8,["post"]),K(an)])):he("",!0)]),_:1})])])}}},Bf=wt(jf,[["__scopeId","data-v-4f36b454"]]),Ff={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2"},Hf={class:"text-catppuccin-subtle text-sm mb-3"},Vf={key:0,class:"text-catppuccin-mauve"},Uf={key:0,class:"text-sm text-catppuccin-subtle"},Wf={key:1,class:"grid gap-4 sm:grid-cols-2"},Gf=["onClick"],qf={key:0,class:"w-full h-32 sm:h-40 overflow-hidden bg-catppuccin-surface/30"},Kf=["src","alt"],zf={class:"px-3 sm:px-4 py-3"},Yf={class:"flex items-start gap-2 mb-2"},Jf={class:"text-sm text-catppuccin-gray mb-3 leading-relaxed line-clamp-2"},Qf={class:"flex items-center gap-2 flex-wrap"},Zf=["onClick"],Xf={key:0,class:"text-xs text-catppuccin-subtle"},eh={__name:"ProjectList",props:{projects:{type:Array,default:()=>[]},selectedTag:{type:String,default:null}},emits:["open-project","select-tag"],setup(e,{emit:t}){const n=t,s=o=>{n("open-project",o)};return(o,r)=>(C(),S("div",Ff,[g("div",Hf,[r[0]||(r[0]=Ue(" ~$ ls -la projects/ ",-1)),e.selectedTag?(C(),S("span",Vf,'| grep "'+V(e.selectedTag)+'"',1)):he("",!0)]),e.projects.length?(C(),S("div",Wf,[(C(!0),S(Z,null,Ce(e.projects,i=>(C(),S("div",{key:i.id,onClick:a=>s(i.slug),class:"block group rounded-md border bg-catppuccin-base/20 hover:bg-catppuccin-base/30 transition-all cursor-pointer overflow-hidden",style:ye({borderColor:`${i.accentColorHex}40`})},[i.coverImage?(C(),S("div",qf,[g("img",{src:i.coverImage,alt:i.title,class:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"},null,8,Kf)])):he("",!0),g("div",zf,[g("div",Yf,[g("span",{class:"text-sm transition-colors",style:ye({color:i.accentColorHex})},">",4),g("h2",{class:"text-base font-semibold text-catppuccin-text group-hover:text-catppuccin-mauve transition-colors",style:ye({"--hover-color":i.accentColorHex})},V(i.title),5)]),g("p",Jf,V(i.description),1),g("div",Qf,[(C(!0),S(Z,null,Ce(i.tags.slice(0,3),a=>(C(),S("span",{key:a,onClick:ta(c=>n("select-tag",a),["stop"]),class:"px-2 py-1 sm:py-0.5 rounded text-xs bg-catppuccin-surface/60 text-catppuccin-subtle hover:text-catppuccin-mauve cursor-pointer transition-colors",style:ye({"--hover-bg":`${i.accentColorHex}20`})}," #"+V(a),13,Zf))),128)),i.tags.length>3?(C(),S("span",Xf," +"+V(i.tags.length-3),1)):he("",!0),g("span",{class:"ml-auto text-catppuccin-subtle group-hover:text-catppuccin-mauve transition-colors text-sm",style:ye({"--hover-color":i.accentColorHex})}," view → ",4)])])],12,Gf))),128))])):(C(),S("div",Uf," no projects found "))]))}},th=wt(eh,[["__scopeId","data-v-b7be8c48"]]),nh={class:"mb-8"},sh={class:"text-catppuccin-subtle text-sm mb-2"},oh=["src","alt"],rh={class:"flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-catppuccin-subtle mb-4"},ih={class:"flex flex-wrap gap-2"},ah={class:"flex flex-wrap gap-3 mb-6"},ch=["href"],lh=["href"],uh={key:0,class:"mb-6 border border-catppuccin-surface rounded-md p-4 bg-catppuccin-surface/10"},dh={class:"space-y-3"},ph=["for"],fh=["id","onUpdate:modelValue","placeholder"],hh={class:"sm:border-l-2 sm:border-catppuccin-surface sm:pl-4 pl-2 mb-8 overflow-hidden"},mh=["innerHTML"],gh={__name:"ProjectComponent",props:{project:{type:Object,required:!0}},emits:["go-back"],setup(e,{emit:t}){const n=e,s=t,o=()=>{s("go-back")},r=me({}),i=ee(()=>ns.extractVariables(n.project.content)),a=ee(()=>ns.substitute(n.project.content,r.value)),c=u=>ga.parse(u);return lt(()=>{ss.highlightAfterDelay(100)}),It(r,()=>{ds(()=>{ss.highlightAll()})},{deep:!0}),(u,l)=>(C(),S("div",{style:ye({"--accent-color":e.project.accentColorHex})},[g("div",nh,[g("div",sh," ~$ cat "+V(e.project.slug)+".md ",1),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all mb-6 inline-flex items-center gap-1.5 group"},[...l[0]||(l[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/projects",-1)])]),e.project.coverImage?(C(),S("div",{key:0,class:"w-full h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden mb-6 border",style:ye({borderColor:`${e.project.accentColorHex}40`})},[g("img",{src:e.project.coverImage,alt:e.project.title,class:"w-full h-full object-cover"},null,8,oh)],4)):he("",!0),g("h1",{class:"text-3xl md:text-4xl font-bold mb-3",style:ye({color:e.project.accentColorHex})},V(e.project.title),5),g("div",rh,[g("span",{class:$t(["px-2 py-0.5 rounded text-xs capitalize",{"bg-catppuccin-green/20 text-catppuccin-green":e.project.status==="active","bg-catppuccin-yellow/20 text-catppuccin-yellow":e.project.status==="in-progress","bg-catppuccin-red/20 text-catppuccin-red":e.project.status==="archived","bg-catppuccin-blue/20 text-catppuccin-blue":e.project.status==="beta","bg-catppuccin-peach/20 text-catppuccin-peach":e.project.status==="stale"}])},V(e.project.status),3),g("div",ih,[(C(!0),S(Z,null,Ce(e.project.tags,d=>(C(),S("span",{key:d,class:"text-catppuccin-gray"}," #"+V(d),1))),128))])]),g("div",ah,[e.project.url?(C(),S("a",{key:0,href:e.project.url,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border text-sm transition-colors hover:bg-catppuccin-surface/30",style:ye({borderColor:`${e.project.accentColorHex}60`,color:e.project.accentColorHex})},[...l[1]||(l[1]=[g("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[g("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})],-1),Ue(" Live Site ",-1)])],12,ch)):he("",!0),e.project.github?(C(),S("a",{key:1,href:e.project.github,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-3 py-1.5 rounded border border-catppuccin-surface/60 text-sm text-catppuccin-subtle transition-colors hover:bg-catppuccin-surface/30 hover:text-catppuccin-text"},[...l[2]||(l[2]=[g("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24"},[g("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})],-1),Ue(" GitHub ",-1)])],8,lh)):he("",!0)])]),i.value.length>0?(C(),S("div",uh,[l[3]||(l[3]=g("div",{class:"text-sm text-catppuccin-subtle mb-3"}," ~$ configure variables ",-1)),g("div",dh,[(C(!0),S(Z,null,Ce(i.value,d=>(C(),S("div",{key:d,class:"flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3"},[g("label",{for:`var-${d}`,class:"text-sm text-catppuccin-text sm:min-w-[120px]"},V(d)+": ",9,ph),ui(g("input",{id:`var-${d}`,"onUpdate:modelValue":f=>r.value[d]=f,type:"text",placeholder:d,class:"flex-1 px-3 py-2 text-sm bg-catppuccin-base border border-catppuccin-surface/60 rounded text-catppuccin-text placeholder-catppuccin-subtle focus:outline-none focus:border-catppuccin-mauve transition-colors"},null,8,fh),[[ea,r.value[d]]])]))),128))])])):he("",!0),g("article",hh,[g("div",{class:"prose prose-invert max-w-none text-catppuccin-text",innerHTML:c(a.value)},null,8,mh)]),g("button",{onClick:o,class:"text-sm px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...l[4]||(l[4]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/projects",-1)])])],4))}},bh=wt(gh,[["__scopeId","data-v-b3acbc76"]]),vh={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},yh={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16"},xh={key:"list"},wh={class:"mb-12"},_h={class:"flex items-center gap-4 text-sm mb-6"},kh={key:"project"},Ch={__name:"Projects",setup(e){const t=me("list"),n=me(null),s=me(null),o=me([]),r=me([]),i=Co(),a=Mn(),c=ee(()=>s.value?o.value.filter(m=>m.tags.includes(s.value)):o.value),u=()=>{o.value=ws(),r.value=Ud()},l=m=>{if(n.value=Vd(m),n.value)t.value="project",window.scrollTo({top:0,behavior:"instant"}),i.query.project!==m&&a.replace({name:"Projects",query:{...i.query,project:m}});else if(i.query.project){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},d=({skipQueryUpdate:m=!1}={})=>{if(t.value="list",n.value=null,window.scrollTo({top:0,behavior:"smooth"}),!m&&"project"in i.query){const v={...i.query};delete v.project,a.replace({name:"Projects",query:v})}},f=m=>{s.value=s.value===m?null:m};return lt(()=>{u(),document.documentElement.style.overflowY="auto",document.body.style.overflowY="auto",new ClipboardJS("[data-clipboard-target]").on("success",function(A){const L=A.trigger,I=L.textContent;L.textContent="copied!",L.classList.add("text-catppuccin-green"),setTimeout(()=>{L.textContent=I,L.classList.remove("text-catppuccin-green")},2e3),A.clearSelection()}),setTimeout(()=>{window.Prism&&Prism.highlightAll()},100);const v=i.query.project;v&&l(v)}),On(()=>{document.documentElement.style.overflowY="",document.body.style.overflowY=""}),It(()=>i.query.project,(m,v)=>{m&&m!==v?l(m):!m&&t.value==="project"&&d({skipQueryUpdate:!0})}),(m,v)=>{const A=hs("router-link");return C(),S("div",vh,[g("div",yh,[K(vs,{name:"fade",mode:"out-in"},{default:ct(()=>[t.value==="list"?(C(),S("div",xh,[g("div",wh,[v[1]||(v[1]=g("div",{class:"text-catppuccin-subtle text-sm mb-2"}," ~$ cd ~/projects ",-1)),g("div",_h,[K(A,{to:"/",class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},{default:ct(()=>[...v[0]||(v[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])]),_:1})]),v[2]||(v[2]=g("h1",{class:"text-3xl md:text-4xl font-bold text-catppuccin-text mb-4"},[g("span",{class:"text-catppuccin-mauve"},"Projects")],-1)),v[3]||(v[3]=g("p",{class:"text-sm text-catppuccin-gray leading-relaxed mb-6"}," A collection of projects I've worked on, ranging from web applications to plugins and tools. ",-1)),K(ma,{tags:r.value,"selected-tag":s.value,onToggleTag:f},null,8,["tags","selected-tag"])]),K(th,{projects:c.value,"selected-tag":s.value,onOpenProject:l,onSelectTag:f},null,8,["projects","selected-tag"]),K(an)])):t.value==="project"&&n.value?(C(),S("div",kh,[K(bh,{project:n.value,onGoBack:d},null,8,["project"]),K(an)])):he("",!0)]),_:1})])])}}},Sh=wt(Ch,[["__scopeId","data-v-ce80c82b"]]),Eh={class:"w-full min-h-screen h-screen overflow-x-hidden overflow-y-auto font-mono"},Ah={class:"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-16"},Ph={class:"mb-8"},Th={class:"text-catppuccin-subtle text-sm mb-4"},Rh={class:"border-l-2 border-catppuccin-surface pl-4"},Ih={class:"text-catppuccin-red text-sm"},Dh={class:"text-catppuccin-mauve"},Oh={__name:"NotFound",setup(e){const t=Co(),n=Mn(),s=ee(()=>(t.fullPath||t.path||"/").replace(/^\//,"")||"."),o=()=>n.push("/");return(r,i)=>(C(),S("div",Eh,[g("div",Ah,[g("div",Ph,[g("div",Th," ~$ cd ~/"+V(s.value),1),g("div",{class:"flex items-center gap-4 text-sm mb-6"},[g("button",{onClick:o,class:"px-3 py-1.5 rounded-md border border-catppuccin-surface/60 bg-catppuccin-base/20 hover:bg-catppuccin-base/30 hover:border-catppuccin-mauve/40 transition-all inline-flex items-center gap-1.5 group"},[...i[0]||(i[0]=[g("span",{class:"text-catppuccin-subtle group-hover:text-catppuccin-text transition-colors"},"cd",-1),g("span",{class:"text-catppuccin-mauve font-medium"},"~/",-1),g("span",{class:"text-catppuccin-subtle font-medium"},"(home)",-1)])])])]),g("div",Rh,[g("div",Ih,[i[1]||(i[1]=Ue(" cd: no such file or directory: /",-1)),g("span",Dh,V(s.value),1)])])]),K(an)]))}},$h=[{path:"/",name:"Home",component:Mp,meta:{title:"Home | heckr.dev"}},{path:"/posts",name:"Posts",component:Bf,meta:{title:"Posts | heckr.dev"}},{path:"/projects",name:"Projects",component:Sh,meta:{title:"Projects | heckr.dev"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:Oh,meta:{title:"404 Not Found | heckr.dev"}}],ba=Yu({history:Au(),routes:$h,scrollBehavior(e,t,n){return n||{top:0}}});ba.beforeEach((e,t,n)=>{document.title=e.meta.title||"heckr.dev",n()});let pn=0;const Dr=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","KeyB","KeyA"],Mh=()=>{console.log("%cWelcome to heckr.dev","font-size: 20px; font-weight: bold; color: #cba6f7;"),console.log("%cWelcome to the dev console, here are some commands to try:","font-size: 14px; color: #a6adc8;"),console.log(`%c- help() - show available commands
...
Feel free to reach out!`,"font-size: 12px; color: #a6adc8;")},window.secret=()=>{console.log("%cYou found the secret command","font-size: 18px; font-weight: bold; color: #f9e2af;"),console.log("%cHere's a hint: ↑ ↑ ↓ ↓ ← → ← → B A","font-size: 12px; color: #fab387;")},document.addEventListener("keydown",e=>{e.code===Dr[pn]?(pn++,pn===Dr.length&&(Lh(),pn=0)):pn=0})},Lh=()=>{if(console.log("%cKONAMI CODE ACTIVATED!","font-size: 24px; font-weight: bold; color: #f9e2af; text-shadow: 2px 2px 4px #000;"),document.body.style.animation="rainbow-border 2s linear infinite",!document.getElementById("konami-style")){const e=document.createElement("style");e.id="konami-style",e.textContent=`
    ...
    `,document.head.appendChild(e)}setTimeout(()=>{document.body.style.animation=""},5e3)};Hl(Ju).use(ba).mount("#app");Mh();
